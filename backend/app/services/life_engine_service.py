...
2. 用户本人统一称为“用户”“本人”或“当事人”，不要自行起名。
3. 如需描述关系，只能使用“家人”“导师”“伴侣”“雇主”“城市”“行业”等角色称谓。
4. 所有因素和因果链都必须从用户已提供的信息合理外推，不能补充未经提供的传记细节。
...
严格约束：
1. 不要凭空捏造用户本人的姓名。Self Agent 的 `name` 必须写“本人”或“用户本人”。
2. 如果用户没有提供其他人的具体姓名，也不要乱造真实人名；优先使用“家人”“导师A”“当前雇主”“目标公司”等角色化称谓。
3. 注意人称关系：Self 是用户本人；Family/Mentor/Partner/Employer 等都是影响用户的人或系统，不要混淆主体。
4. 不要添加没有依据的家庭结构、个人履历、具体公司高管姓名等细节。
...
严格约束：
1. 不要凭空捏造用户姓名。涉及 Self 时统一使用“本人”或“用户”。
2. 不要凭空生成未提供的真实人名；如需指代他人，只能使用角色称谓或中性代号，如“导师A”“家人”“当前雇主”。
3. 注意人称关系：Self 是决策主体，其他 Agent 是外部影响者，不要混淆“我”“用户”“导师”“家人”等主体。
4. 所有叙事必须基于当前状态、已有角色和历史摘要，不要加入没有依据的传记细节。
...
def _make_fallback_agents() -> list[dict]:
    ...
    return [
        {"agent_id": gen_id(), "agent_type": "Self", "name": "本人", "persona": "用户本人", "stance": "neutral", "resources": "个人能力与努力", "influence": 1.0, "active": True},
