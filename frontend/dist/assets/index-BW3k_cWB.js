(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const s of a)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function n(a){const s={};return a.integrity&&(s.integrity=a.integrity),a.referrerPolicy&&(s.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?s.credentials="include":a.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(a){if(a.ep)return;a.ep=!0;const s=n(a);fetch(a.href,s)}})();const ne="";async function tt(t,e,n=null){const i={method:t,headers:{"Content-Type":"application/json"}};n&&(i.body=JSON.stringify(n));const a=await fetch(`${ne}${e}`,i);if(!a.ok){const s=await a.json().catch(()=>({detail:a.statusText}));throw new Error(s.detail||"API Error")}return a.json()}const X={health:()=>tt("GET","/api/health"),createProject:t=>tt("POST","/api/projects",{title:t}),importProject:t=>tt("POST","/api/projects/import",t),listProjects:()=>tt("GET","/api/projects"),getProject:t=>tt("GET",`/api/projects/${t}`),deleteProject:t=>tt("DELETE",`/api/projects/${t}`),submitProfile:(t,e)=>tt("POST",`/api/projects/${t}/profile`,e),submitParameters:(t,e)=>tt("POST",`/api/projects/${t}/parameters`,{parameters:e}),startSimulation:(t,e=12,n="quarter",i=6)=>fetch(`${ne}/api/projects/${t}/simulate`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({rounds:e,time_unit:n,agent_count:i})}),reSimulate:(t,e=12,n="quarter",i=6)=>fetch(`${ne}/api/projects/${t}/re-simulate`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({rounds:e,time_unit:n,agent_count:i})}),backtrack:(t,e,n,i,a,s=6)=>fetch(`${ne}/api/projects/${t}/backtrack`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({path_id:e,node_index:n,modifications:i,description:a,rounds:s})}),getPaths:t=>tt("GET",`/api/projects/${t}/paths`),getPathDetail:(t,e)=>tt("GET",`/api/projects/${t}/paths/${e}`),getAdvice:(t,e,n="satisfied")=>tt("POST",`/api/projects/${t}/paths/${e}/advice`,{feedback:n}),getGraph:t=>tt("GET",`/api/projects/${t}/graph`),getAgents:t=>tt("GET",`/api/projects/${t}/agents`),getReport:t=>tt("GET",`/api/projects/${t}/report`),getTreeEvents:t=>tt("GET",`/api/projects/${t}/tree-events`)},pn={zh:{nav_simulation:"推演",nav_graph:"图谱",nav_reports:"报告",nav_system:"系统",landing_tag:"[PROLOGUE_01]",landing_title_1:"人生不是终点。",landing_title_2:"它是一个变量。",landing_desc:"通过多智能体仿真推演，量化人生轨迹中的关键节点。调一下参数，看看你的未来会走向哪里。",landing_cta:"[开始推演]",landing_history:"[历史记录]",onboarding_title:"构建你的人物模型",step_personality:"性格分析",step_education:"教育背景",step_academic:"学术信息",step_family:"家庭背景",step_career:"职业倾向",step_concern:"核心困惑",btn_next:"下一步",btn_prev:"上一步",btn_submit:"提交档案",param_title:"定义关注参数",param_desc:"明确本次推演的核心问题。系统将围绕你的关注参数，自动发散多层影响因素并生成智能体。",param_add:"+ 添加参数",param_primary:"主参数",param_secondary:"次参数",sim_config:"推演配置",sim_rounds:"推演轮数",sim_time_unit:"时间单位",sim_quarter:"每季度",btn_start_sim:"开始推演",btn_back_profile:"返回档案",sim_viewport:"SIMULATION_VIEWPORT",sim_tree_title:"人生路径树",sim_event_stream:"事件流",sim_metrics:"系统指标",sim_progress:"进度",sim_paths:"路径数",sim_branches:"分支数",sim_round:"当前轮次",sim_initializing:"初始化中",sim_waiting:"等待推演开始...",sim_state:"当前状态",sim_completed_view:"推演已完成",sim_completed_msg:"本项目的推演已完成，点击下方按钮查看结果。",sim_tab_tree:"推演树",sim_tab_actions:"结果导航",sim_tree_readonly:"只读模式",sim_tree_summary:"推演摘要",btn_view_graph:"查看知识图谱",btn_view_results:"查看推演报告",btn_re_simulate:"重新推演",graph_title:"人生图谱",graph_agents:"智能体",graph_node_detail:"节点详情",graph_no_agents:"暂无智能体数据",graph_no_data:"暂无图谱数据",graph_load_error:"图谱加载失败",btn_view_report:"查看推演结果",results_title:"路径分析报告",results_desc:"系统已完成推演，生成 {count} 条人生路径。点击路径卡片查看详情。",results_status:"状态: 已完成",path_optimal:"最优路径",path_conservative:"稳健路径",path_risk:"冒险路径",path_balanced:"平衡路径",path_satisfaction:"满意度预测",path_nodes:"节点数",path_risk_label:"风险",btn_new_sim:"新建推演",btn_back:"返回",detail_node_seq:"节点序列",detail_description:"描述",detail_trigger:"触发原因",detail_state_snapshot:"状态快照",btn_get_advice:"获取 AI 建议",advice_title:"策略规划",advice_desc:"针对「{path}」的 AI 行动建议",advice_satisfied:"满意模式",advice_unsatisfied:"不满意模式",advice_choose:"选择反馈模式以生成建议...",advice_generating:"正在生成建议...",advice_immediate:"近期行动",advice_mid_term:"中期布局",advice_risk_mit:"风险规避",advice_risk_analysis:"风险分析",advice_intervention:"干预节点",advice_alternative:"替代路径",advice_mental:"心理支持",advice_key_nodes:"关键节点",state_education:"学业",state_career:"职业",state_finance:"经济",state_health:"健康",state_mental:"心理",state_relationship:"关系",state_family_support:"家庭",state_social_capital:"社会资本",state_optionality:"可选择空间",state_goal_alignment:"目标达成",lang_switch:"EN",error_loading:"加载失败"},en:{nav_simulation:"SIMULATE",nav_graph:"GRAPH",nav_reports:"REPORTS",nav_system:"SYSTEM",landing_tag:"[PROLOGUE_01]",landing_title_1:"Life is not a destination.",landing_title_2:"It's a variable.",landing_desc:"Simulate life trajectories through multi-agent modeling. Tweak the parameters and see where your future leads.",landing_cta:"[START SIMULATION]",landing_history:"[VIEW HISTORY]",onboarding_title:"Build Your Profile",step_personality:"Personality",step_education:"Education",step_academic:"Academic",step_family:"Family",step_career:"Career",step_concern:"Core Concern",btn_next:"Next",btn_prev:"Previous",btn_submit:"Submit Profile",param_title:"Define Concern Parameters",param_desc:"Define your core questions. The system will diverge multi-layer influence factors and generate agents around your concerns.",param_add:"+ Add Parameter",param_primary:"Primary",param_secondary:"Secondary",sim_config:"Simulation Config",sim_rounds:"Rounds",sim_time_unit:"Time Unit",sim_quarter:"Quarterly",btn_start_sim:"Start Simulation",btn_back_profile:"Back to Profile",sim_viewport:"SIMULATION_VIEWPORT",sim_tree_title:"Life-Path Tree",sim_event_stream:"EVENT_STREAM",sim_metrics:"SYSTEM_METRICS",sim_progress:"PROGRESS",sim_paths:"PATHS",sim_branches:"BRANCHES",sim_round:"ROUND",sim_initializing:"INITIALIZING",sim_waiting:"Waiting for simulation start...",sim_state:"CURRENT_STATE",sim_completed_view:"Simulation Complete",sim_completed_msg:"Simulation has already finished. Click below to view results.",sim_tab_tree:"Derivation Tree",sim_tab_actions:"Result Hub",sim_tree_readonly:"Read-only",sim_tree_summary:"Summary",btn_view_graph:"View Knowledge Graph",btn_view_results:"View Simulation Report",btn_re_simulate:"Re-simulate",graph_title:"LIFE_GRAPH",graph_agents:"AGENTS",graph_node_detail:"NODE_DETAIL",graph_no_agents:"No agents data yet",graph_no_data:"No graph data available",graph_load_error:"GRAPH_LOAD_ERROR",btn_view_report:"View Results",results_title:"Path Analysis Report",results_desc:"Simulation complete. {count} life paths generated. Click a card to view details.",results_status:"STATUS: COMPLETED",path_optimal:"Optimal Path",path_conservative:"Conservative Path",path_risk:"Risk Path",path_balanced:"Balanced Path",path_satisfaction:"Satisfaction",path_nodes:"Nodes",path_risk_label:"Risk",btn_new_sim:"New Simulation",btn_back:"Back",detail_node_seq:"NODE_SEQUENCE",detail_description:"Description",detail_trigger:"Trigger Reason",detail_state_snapshot:"State Snapshot",btn_get_advice:"Get AI Advice",advice_title:"Strategy Protocol",advice_desc:'AI-powered advice for "{path}"',advice_satisfied:"Satisfied Mode",advice_unsatisfied:"Unsatisfied Mode",advice_choose:"Choose feedback mode to generate advice...",advice_generating:"GENERATING_ADVICE...",advice_immediate:"Immediate Actions",advice_mid_term:"Mid-term Plan",advice_risk_mit:"Risk Mitigation",advice_risk_analysis:"Risk Analysis",advice_intervention:"Intervention Points",advice_alternative:"Alternative Paths",advice_mental:"Mental Support",advice_key_nodes:"Key Nodes",state_education:"Education",state_career:"Career",state_finance:"Finance",state_health:"Health",state_mental:"Mental",state_relationship:"Relationship",state_family_support:"Family",state_social_capital:"Social Capital",state_optionality:"Optionality",state_goal_alignment:"Goal Alignment",lang_switch:"中文",error_loading:"Loading failed"}};let Ve=localStorage.getItem("lifepath_lang")||"zh";function S(t){var e;return((e=pn[Ve])==null?void 0:e[t])||pn.zh[t]||t}function Hi(t){Ve=t,localStorage.setItem("lifepath_lang",t)}function ji(){Hi(Ve==="zh"?"en":"zh")}function qe(t){return S(`state_${t}`)}const Hn=["education","career","finance","health","mental","relationship","family_support","social_capital","optionality","goal_alignment"];function Fi(t){t.innerHTML=`
  ...
  `}function Gn(){const t=Fn();switch(t.key){case"personality":return`
      ...
      `;case"background":return qi();case"family":return`
        ...
        <div class="form-group mt-24">
          ...
          ${Tt(($t()?["稳定发展","尽快晋升","回本省定居","收入优先","自由选择"]:["考公/体制内","留在本省","高薪优先","自由选择","读博深造"]).map(e=>({value:e,label:e})),"family_expectation",O.family_expectation)}
        </div>
      `;case"preference":return`
        <h2 style="font-family:var(--font-headline);font-size:32px;font-weight:700;margin-bottom:8px;">${t.title}</h2>
        <p class="text-secondary mb-24">${$t()?"职业路线、转型方式和风险承受度会直接影响回溯分支。":"职业方向与风险偏好会影响后续推演走向。"}</p>
        <div class="form-group">
      ...
      `;case"concern":return`
        ...
        <div class="form-group">
          ...
          <textarea class="form-textarea" id="field-concern" placeholder="${$t()?"例如：我是继续留在当前公司争取管理岗，还是转去更高风险的新赛道？":"例如：我应该保研还是直接就业？如果选择保研，3 年后的发展会比直接工作更好吗？"}">${O.current_concern}</textarea>
        </div>
        <div class="card mt-24" style="background:var(--surface-low);border-left:2px solid var(--accent);padding:20px;">
  ...
  `,Yn(t),t.querySelectorAll(".step-item").forEach(n=>{n.addEventListener("click",()=>{const i=parseInt(n.dataset.step,10);i<=K&&(we(),K=i,ae(t))})}),document.getElementById("btn-prev").addEventListener("click",()=>{K>0&&(we(),K-=1,ae(t))}),document.getElementById("btn-next").addEventListener("click",async()=>{if(we(),K<e.length-1){K+=1,ae(t);return}try{await X.submitProfile($.projectId,O),K=0,Q("parameters")}catch(n){alert("Profile submission failed: "+n.message)}})}function Yn(t){t.querySelectorAll(".radio-card").forEach(e=>{e.addEventListener("click",()=>{const n=e.dataset.field,i=e.dataset.value;Vi(n,i),document.getElementById("step-content").innerHTML=Gn(),Yn(t)})})}function we(){var e,n,i,a,s;switch(Fn().key){case"background":O.school=((e=document.getElementById("field-school"))==null?void 0:e.value)||"",O.major=((n=document.getElementById("field-major"))==null?void 0:n.value)||"",O.gpa_range=$t()?"":((i=document.getElementById("field-gpa"))==null?void 0:i.value)||"",O.city_preference=((a=document.getElementById("field-city"))==null?void 0:a.value)||"";break;case"concern":O.current_concern=((s=document.getElementById("field-concern"))==null?void 0:s.value)||"";break}}let at=[{name:"",description:"",priority:"primary",weight:1}],fn=null;const Ui=["primary","secondary","constraint"],Xi={primary:"主参数",secondary:"次参数",constraint:"约束条件"};function Ae(t){var e,n;fn!==$.projectId&&(fn=$.projectId,Array.isArray((e=$.project)==null?void 0:e.parameters)&&$.project.parameters.length>0?at=$.project.parameters.map(i=>({name:i.name||"",description:i.description||"",priority:i.priority||"primary",weight:Number.isFinite(i.weight)?i.weight:1})):at=[{name:"",description:"",priority:"primary",weight:1}]),Array.isArray((n=$.project)==null?void 0:n.parameters)&&$.project.parameters.length>0&&at.length===0&&(at=$.project.parameters.map(i=>({name:i.name||"",description:i.description||"",priority:i.priority||"primary",weight:Number.isFinite(i.weight)?i.weight:1}))),t.innerHTML=`
  ...
  `,F=[],Dt=[],Un(),Xn(),ve(),Mt([]),Vn(),Ki(),ea(t)}function ve(){se&&(se(),se=null)}function Vn({replay:t=!1}={}){ve(),se=Rl(e=>{Jn(e),Ue(),Xe()},{replay:t})}function Ue(){const t=F.filter(i=>i.isBranch).length,e=document.getElementById("metric-branches");e&&(e.textContent=t||(F.length?1:"—"));const n=document.getElementById("metric-nodes");n&&(n.textContent=F.length||"—")}function Xe(){const t=document.getElementById("tree-summary-panel");if(t){if(F.length===0){t.innerHTML=`
...
`);s=c.pop()||"";for(const l of c)if(l.startsWith("data: "))try{const d=JSON.parse(l.slice(6));na(d,t)}catch{}}}catch(n){qn("ERROR",`Simulation failed: ${n.message}`,!0)}}function na(t,e){const{phase:n,progress:i,message:a,round:s,total:r,path_count:o,agent_count:c,engine:l,tree_event:d}=t,_=document.getElementById("progress-fill"),f=document.getElementById("progress-label");_&&f&&i!==void 0&&(_.style.width=`${i}%`,f.style.left=`${i}%`,f.textContent=`${i}%`);const h=document.getElementById("metric-progress");if(h&&i!==void 0&&(h.textContent=`${i}%`),n==="tree_event"&&d){cn(d);return}if(a){const y=new Date().toLocaleTimeString("en-US",{hour12:!1});qn(y,a,n==="completed"||n==="branch")}if(n==="branch"){const y=document.getElementById("metric-branches");if(y){const x=parseInt(y.textContent)||1;y.textContent=x+1}}if(n==="simulating"){const y=document.getElementById("metric-round");if(y&&a){const x=a.match(/第 (\d+)/);x&&(y.textContent=x[1])}}const E=document.getElementById("state-label");if(E){if(n==="init")E.textContent="⚡ AI_ENGINE";else if(n==="parameter_expansion")E.textContent="AI_EXPAND";else if(n==="agent_generation")E.textContent="AGENT_GEN";else if(n==="graph_building")E.textContent="GRAPH_BUILD";else if(n==="simulating")E.textContent="SIM_ACTIVE";else if(n==="branch")E.textContent="🌿 BRANCH";else if(n==="generating_paths")E.textContent="PATH_GEN";else if(n==="error"){E.textContent="❌ ERROR";const y=document.getElementById("status-dot");y&&(y.classList.remove("pulse"),y.classList.add("status-error"))}else if(n==="completed"){E.textContent="✅ AI_COMPLETE";const y=document.getElementById("status-dot");y&&(y.classList.remove("pulse"),y.classList.add("status-stable"));const x=document.getElementById("metric-paths");x&&(x.textContent=o||0),$.simComplete=!0,$.project&&($.project.status="completed"),$.simulationTab="tree",setTimeout(()=>We(e),700)}}}function qn(t,e,n=!1){const i=document.getElementById("event-log");if(!i)return;i.querySelectorAll(".console-latest").forEach(s=>s.classList.remove("console-latest"));const a=document.createElement("div");a.className=`console-line ${n?"console-latest":""}`,a.innerHTML=`
  ...
  `}function ca(t,e){if(!t||!(e!=null&&e.id)||t.querySelector(`[data-event-id="${e.id}"]`))return;const n=document.createElement("div");n.dataset.eventId=e.id,n.innerHTML=Me(e),t.prepend(n)}function da(t=[]){return $.selectedPathId&&t.find(e=>e.id===$.selectedPathId)||null}function dt(t,e={}){Object.assign($,{resultsView:t,...e})}async function ut(t){let e=[];try{e=(await X.getPaths($.projectId)).paths||[]}catch(a){t.innerHTML=`<div class="p-48 text-center"><h1>${S("error_loading")}</h1><p>${a.message}</p></div>`;return}const n=$.resultsView||"overview",i=da(e);n==="overview"?hn(t,e):n==="detail"&&i?fa(t,i):n==="advice"&&i?ga(t,i):n==="report"?ti(t):n==="backtrack"&&i?Zn(t,i):(dt("overview",{selectedPathId:null,backtrackNodeIndex:null}),hn(t,e))}function hn(t,e){var i;const n=S("results_desc").replace("{count}",e.length);t.innerHTML=`
  ...
  `}function pa(t){return t?["education","career","finance","health"].map(n=>`
    <div class="path-stat">
      <div class="path-stat-value">${Math.round((t[n]||0)*100)}%</div>
      <div class="path-stat-label">${qe(n)}</div>
    </div>
  `).join(""):""}function fa(t,e){const n=e.nodes||[],i=n[0];t.innerHTML=`
...
`);B=Y.pop()||"";for(const m of Y)if(m.startsWith("data: "))try{const u=JSON.parse(m.slice(6));f!=null&&f.isConnected&&u.message&&(f.innerHTML=`<span class="console-ts">[BT]</span><span>${u.message}</span>`),h!=null&&h.isConnected&&u.progress!==void 0&&(h.style.width=`${u.progress}%`),u.phase==="tree_event"&&u.tree_event&&(cn(u.tree_event),ca(E,u.tree_event)),u.phase==="completed"&&(T=u.new_path_id||null,$.simComplete=!0,$.simulationTab="tree",$.project&&($.project.status="completed"),f!=null&&f.isConnected&&(f.innerHTML=`<span class="console-ts" style="color:var(--accent);">[DONE]</span><span style="font-weight:700;color:var(--accent);">${u.message}</span>`,f.classList.remove("pulse")),y&&(y.style.display="flex",y.style.gap="8px",y.style.flexWrap="wrap",y.innerHTML=`
  ...
  `,(n=document.getElementById("btn-back-from-report"))==null||n.addEventListener("click",()=>{dt("overview"),ut(t)});try{const a=await X.getReport($.projectId);ma(a)}catch(a){document.getElementById("report-content").innerHTML=`
    ...
    `,(i=document.getElementById("btn-retry-report"))==null||i.addEventListener("click",()=>{ti(t)})}}function ma(t){const e=document.getElementById("report-content");if(!e)return;const n=t.path_comparison||[],i=t.critical_nodes||[],a=t.next_steps||[];e.innerHTML=`
    <div class="fade-in">
      <!-- Executive Summary -->
      <div class="card mb-24" style="border-left:4px solid var(--accent);padding:32px;">
        <h2 style="margin-bottom:16px;line-height:1.3;word-break:break-word;">${la(t.title)}</h2>
  ...
  `}async function ga(t,e){t.innerHTML=`
    <div style="padding:48px 64px;">
      <div class="mono-xs text-accent mb-8">[SYSTEM_DIRECTIVE]</div>
      <div class="flex justify-between items-end mb-48">
        <div>
  ...
  `,document.getElementById("btn-back-detail").addEventListener("click",()=>{dt("detail"),ut(t)}),document.getElementById("btn-satisfied").addEventListener("click",()=>gn(t,"satisfied")),document.getElementById("btn-unsatisfied").addEventListener("click",()=>gn(t,"unsatisfied"))}async function gn(t,e){const n=document.getElementById("advice-content");n.innerHTML=`<div class="p-32 text-center mono-xs pulse">${S("advice_generating")}</div>`;try{const i=await X.getAdvice($.projectId,$.selectedPathId,e);e==="satisfied"?n.innerHTML=`
      ...
      `}catch(i){n.innerHTML=`<div class="p-32 text-center text-error">Error: ${i.message}</div>`}}var va={value:()=>{}};function Yt(){for(var t=0,e=arguments.length,n={},i;t<e;++t){if(!(i=arguments[t]+"")||i in n||/[\s.]/.test(i))throw new Error("illegal type: "+i);n[i]=[]}return new re(n)}function re(t){this._=t}function ya(t,e){return t.trim().split(/^|\s+/).map(function(n){var i="",a=n.indexOf(".");if(a>=0&&(i=n.slice(a+1),n=n.slice(0,a)),n&&!e.hasOwnProperty(n))throw new Error("unknown type: "+n);return{type:n,name:i}})}re.prototype=Yt.prototype={constructor:re,on:function(t,e){var n=this._,i=ya(t+"",n),a,s=-1,r=i.length;if(arguments.length<2){for(;++s<r;)if((a=(t=i[s]).type)&&(a=ba(n[a],t.name)))return a;return}if(e!=null&&typeof e!="function")throw new Error("invalid callback: "+e);for(;++s<r;)if(a=(t=i[s]).type)n[a]=vn(n[a],t.name,e);else if(e==null)for(a in n)n[a]=vn(n[a],t.name,null);return this},copy:function(){var t={},e=this._;for(var n in e)t[n]=e[n].slice();return new re(t)},call:function(t,e){if((a=arguments.length-2)>0)for(var n=new Array(a),i=0,a,s;i<a;++i)n[i]=arguments[i+2];if(!this._.hasOwnProperty(t))throw new Error("unknown type: "+t);for(s=this._[t],i=0,a=s.length;i<a;++i)s[i].value.apply(e,n)},apply:function(t,e,n){if(!this._.hasOwnProperty(t))throw new Error("unknown type: "+t);for(var i=this._[t],a=0,s=i.length;a<s;++a)i[a].value.apply(e,n)}};function ba(t,e){for(var n=0,i=t.length,a;n<i;++n)if((a=t[n]).name===e)return a.value}function vn(t,e,n){for(var i=0,a=t.length;i<a;++i)if(t[i].name===e){t[i]=va,t=t.slice(0,i).concat(t.slice(i+1));break}return n!=null&&t.push({name:e,value:n}),t}var Be="http://www.w3.org/1999/xhtml";const yn={svg:"http://www.w3.org/2000/svg",xhtml:Be,xlink:"http://www.w3.org/1999/xlink",xml:"http://www.w3.org/XML/1998/namespace",xmlns:"http://www.w3.org/2000/xmlns/"};function ye(t){var e=t+="",n=e.indexOf(":");return n>=0&&(e=t.slice(0,n))!=="xmlns"&&(t=t.slice(n+1)),yn.hasOwnProperty(e)?{space:yn[e],local:t}:t}function _a(t){return function(){var e=this.ownerDocument,n=this.namespaceURI;return n===Be&&e.documentElement.namespaceURI===Be?e.createElement(t):e.createElementNS(n,t)}}function xa(t){return function(){return this.ownerDocument.createElementNS(t.space,t.local)}}function ei(t){var e=ye(t);return(e.local?xa:_a)(e)}function wa(){}function Qe(t){return t==null?wa:function(){return this.querySelector(t)}}function Ea(t){typeof t!="function"&&(t=Qe(t));for(var e=this._groups,n=e.length,i=new Array(n),a=0;a<n;++a)for(var s=e[a],r=s.length,o=i[a]=new Array(r),c,l,d=0;d<r;++d)(c=s[d])&&(l=t.call(c,c.__data__,d,s))&&("__data__"in c&&(l.__data__=c.__data__),o[d]=l);return new rt(i,this._parents)}function $a(t){return t==null?[]:Array.isArray(t)?t:Array.from(t)}function ka(){return[]}function ni(t){return t==null?ka:function(){return this.querySelectorAll(t)}}function Ia(t){return function(){return $a(t.apply(this,arguments))}}function Ta(t){typeof t=="function"?t=Ia(t):t=ni(t);for(var e=this._groups,n=e.length,i=[],a=[],s=0;s<n;++s)for(var r=e[s],o=r.length,c,l=0;l<o;++l)(c=r[l])&&(i.push(t.call(c,c.__data__,l,r)),a.push(c));return new rt(i,a)}function ii(t){return function(){return this.matches(t)}}function ai(t){return function(e){return e.matches(t)}}var Sa=Array.prototype.find;function Aa(t){return function(){return Sa.call(this.children,t)}}function Na(){return this.firstElementChild}function Ca(t){return this.select(t==null?Na:Aa(typeof t=="function"?t:ai(t)))}var La=Array.prototype.filter;function Ma(){return Array.from(this.children)}function Ba(t){return function(){return La.call(this.children,t)}}function Pa(t){return this.selectAll(t==null?Ma:Ba(typeof t=="function"?t:ai(t)))}function Ra(t){typeof t!="function"&&(t=ii(t));for(var e=this._groups,n=e.length,i=new Array(n),a=0;a<n;++a)for(var s=e[a],r=s.length,o=i[a]=[],c,l=0;l<r;++l)(c=s[l])&&t.call(c,c.__data__,l,s)&&o.push(c);return new rt(i,this._parents)}function si(t){return new Array(t.length)}function Oa(){return new rt(this._enter||this._groups.map(si),this._parents)}function de(t,e){this.ownerDocument=t.ownerDocument,this.namespaceURI=t.namespaceURI,this._next=null,this._parent=t,this.__data__=e}de.prototype={constructor:de,appendChild:function(t){return this._parent.insertBefore(t,this._next)},insertBefore:function(t,e){return this._parent.insertBefore(t,e)},querySelector:function(t){return this._parent.querySelector(t)},querySelectorAll:function(t){return this._parent.querySelectorAll(t)}};function Da(t){return function(){return t}}function za(t,e,n,i,a,s){for(var r=0,o,c=e.length,l=s.length;r<l;++r)(o=e[r])?(o.__data__=s[r],i[r]=o):n[r]=new de(t,s[r]);for(;r<c;++r)(o=e[r])&&(a[r]=o)}function Ha(t,e,n,i,a,s,r){var o,c,l=new Map,d=e.length,_=s.length,f=new Array(d),h;for(o=0;o<d;++o)(c=e[o])&&(f[o]=h=r.call(c,c.__data__,o,e)+"",l.has(h)?a[o]=c:l.set(h,c));for(o=0;o<_;++o)h=r.call(t,s[o],o,s)+"",(c=l.get(h))?(i[o]=c,c.__data__=s[o],l.delete(h)):n[o]=new de(t,s[o]);for(o=0;o<d;++o)(c=e[o])&&l.get(f[o])===c&&(a[o]=c)}function ja(t){return t.__data__}function Fa(t,e){if(!arguments.length)return Array.from(this,ja);var n=e?Ha:za,i=this._parents,a=this._groups;typeof t!="function"&&(t=Da(t));for(var s=a.length,r=new Array(s),o=new Array(s),c=new Array(s),l=0;l<s;++l){var d=i[l],_=a[l],f=_.length,h=Ga(t.call(d,d&&d.__data__,l,i)),E=h.length,y=o[l]=new Array(E),x=r[l]=new Array(E),g=c[l]=new Array(f);n(d,_,y,x,g,h,e);for(var k=0,N=0,v,C;k<E;++k)if(v=y[k]){for(k>=N&&(N=k+1);!(C=x[N])&&++N<E;);v._next=C||null}}return r=new rt(r,i),r._enter=o,r._exit=c,r}function Ga(t){return typeof t=="object"&&"length"in t?t:Array.from(t)}function Ya(){return new rt(this._exit||this._groups.map(si),this._parents)}function Va(t,e,n){var i=this.enter(),a=this,s=this.exit();return typeof t=="function"?(i=t(i),i&&(i=i.selection())):i=i.append(t+""),e!=null&&(a=e(a),a&&(a=a.selection())),n==null?s.remove():n(s),i&&a?i.merge(a).order():a}function qa(t){for(var e=t.selection?t.selection():t,n=this._groups,i=e._groups,a=n.length,s=i.length,r=Math.min(a,s),o=new Array(a),c=0;c<r;++c)for(var l=n[c],d=i[c],_=l.length,f=o[c]=new Array(_),h,E=0;E<_;++E)(h=l[E]||d[E])&&(f[E]=h);for(;c<a;++c)o[c]=n[c];return new rt(o,this._parents)}function Ua(){for(var t=this._groups,e=-1,n=t.length;++e<n;)for(var i=t[e],a=i.length-1,s=i[a],r;--a>=0;)(r=i[a])&&(s&&r.compareDocumentPosition(s)^4&&s.parentNode.insertBefore(r,s),s=r);return this}function Xa(t){t||(t=Wa);function e(_,f){return _&&f?t(_.__data__,f.__data__):!_-!f}for(var n=this._groups,i=n.length,a=new Array(i),s=0;s<i;++s){for(var r=n[s],o=r.length,c=a[s]=new Array(o),l,d=0;d<o;++d)(l=r[d])&&(c[d]=l);c.sort(e)}return new rt(a,this._parents).order()}function Wa(t,e){return t<e?-1:t>e?1:t>=e?0:NaN}function Ja(){var t=arguments[0];return arguments[0]=this,t.apply(null,arguments),this}function Ka(){return Array.from(this)}function Qa(){for(var t=this._groups,e=0,n=t.length;e<n;++e)for(var i=t[e],a=0,s=i.length;a<s;++a){var r=i[a];if(r)return r}return null}function Za(){let t=0;for(const e of this)++t;return t}function ts(){return!this.node()}function es(t){for(var e=this._groups,n=0,i=e.length;n<i;++n)for(var a=e[n],s=0,r=a.length,o;s<r;++s)(o=a[s])&&t.call(o,o.__data__,s,a);return this}function ns(t){return function(){this.removeAttribute(t)}}function is(t){return function(){this.removeAttributeNS(t.space,t.local)}}function as(t,e){return function(){this.setAttribute(t,e)}}function ss(t,e){return function(){this.setAttributeNS(t.space,t.local,e)}}function rs(t,e){return function(){var n=e.apply(this,arguments);n==null?this.removeAttribute(t):this.setAttribute(t,n)}}function os(t,e){return function(){var n=e.apply(this,arguments);n==null?this.removeAttributeNS(t.space,t.local):this.setAttributeNS(t.space,t.local,n)}}function ls(t,e){var n=ye(t);if(arguments.length<2){var i=this.node();return n.local?i.getAttributeNS(n.space,n.local):i.getAttribute(n)}return this.each((e==null?n.local?is:ns:typeof e=="function"?n.local?os:rs:n.local?ss:as)(n,e))}function ri(t){return t.ownerDocument&&t.ownerDocument.defaultView||t.document&&t||t.defaultView}function cs(t){return function(){this.style.removeProperty(t)}}function ds(t,e,n){return function(){this.style.setProperty(t,e,n)}}function us(t,e,n){return function(){var i=e.apply(this,arguments);i==null?this.style.removeProperty(t):this.style.setProperty(t,i,n)}}function ps(t,e,n){return arguments.length>1?this.each((e==null?cs:typeof e=="function"?us:ds)(t,e,n??"")):Ct(this.node(),t)}function Ct(t,e){return t.style.getPropertyValue(e)||ri(t).getComputedStyle(t,null).getPropertyValue(e)}function fs(t){return function(){delete this[t]}}function hs(t,e){return function(){this[t]=e}}function ms(t,e){return function(){var n=e.apply(this,arguments);n==null?delete this[t]:this[t]=n}}function gs(t,e){return arguments.length>1?this.each((e==null?fs:typeof e=="function"?ms:hs)(t,e)):this.node()[t]}function oi(t){return t.trim().split(/^|\s+/)}function Ze(t){return t.classList||new li(t)}function li(t){this._node=t,this._names=oi(t.getAttribute("class")||"")}li.prototype={add:function(t){var e=this._names.indexOf(t);e<0&&(this._names.push(t),this._node.setAttribute("class",this._names.join(" ")))},remove:function(t){var e=this._names.indexOf(t);e>=0&&(this._names.splice(e,1),this._node.setAttribute("class",this._names.join(" ")))},contains:function(t){return this._names.indexOf(t)>=0}};function ci(t,e){for(var n=Ze(t),i=-1,a=e.length;++i<a;)n.add(e[i])}function di(t,e){for(var n=Ze(t),i=-1,a=e.length;++i<a;)n.remove(e[i])}function vs(t){return function(){ci(this,t)}}function ys(t){return function(){di(this,t)}}function bs(t,e){return function(){(e.apply(this,arguments)?ci:di)(this,t)}}function _s(t,e){var n=oi(t+"");if(arguments.length<2){for(var i=Ze(this.node()),a=-1,s=n.length;++a<s;)if(!i.contains(n[a]))return!1;return!0}return this.each((typeof e=="function"?bs:e?vs:ys)(n,e))}function xs(){this.textContent=""}function ws(t){return function(){this.textContent=t}}function Es(t){return function(){var e=t.apply(this,arguments);this.textContent=e??""}}function $s(t){return arguments.length?this.each(t==null?xs:(typeof t=="function"?Es:ws)(t)):this.node().textContent}function ks(){this.innerHTML=""}function Is(t){return function(){this.innerHTML=t}}function Ts(t){return function(){var e=t.apply(this,arguments);this.innerHTML=e??""}}function Ss(t){return arguments.length?this.each(t==null?ks:(typeof t=="function"?Ts:Is)(t)):this.node().innerHTML}function As(){this.nextSibling&&this.parentNode.appendChild(this)}function Ns(){return this.each(As)}function Cs(){this.previousSibling&&this.parentNode.insertBefore(this,this.parentNode.firstChild)}function Ls(){return this.each(Cs)}function Ms(t){var e=typeof t=="function"?t:ei(t);return this.select(function(){return this.appendChild(e.apply(this,arguments))})}function Bs(){return null}function Ps(t,e){var n=typeof t=="function"?t:ei(t),i=e==null?Bs:typeof e=="function"?e:Qe(e);return this.select(function(){return this.insertBefore(n.apply(this,arguments),i.apply(this,arguments)||null)})}function Rs(){var t=this.parentNode;t&&t.removeChild(this)}function Os(){return this.each(Rs)}function Ds(){var t=this.cloneNode(!1),e=this.parentNode;return e?e.insertBefore(t,this.nextSibling):t}function zs(){var t=this.cloneNode(!0),e=this.parentNode;return e?e.insertBefore(t,this.nextSibling):t}function Hs(t){return this.select(t?zs:Ds)}function js(t){return arguments.length?this.property("__data__",t):this.node().__data__}function Fs(t){return function(e){t.call(this,e,this.__data__)}}function Gs(t){return t.trim().split(/^|\s+/).map(function(e){var n="",i=e.indexOf(".");return i>=0&&(n=e.slice(i+1),e=e.slice(0,i)),{type:e,name:n}})}function Ys(t){return function(){var e=this.__on;if(e){for(var n=0,i=-1,a=e.length,s;n<a;++n)s=e[n],(!t.type||s.type===t.type)&&s.name===t.name?this.removeEventListener(s.type,s.listener,s.options):e[++i]=s;++i?e.length=i:delete this.__on}}}function Vs(t,e,n){return function(){var i=this.__on,a,s=Fs(e);if(i){for(var r=0,o=i.length;r<o;++r)if((a=i[r]).type===t.type&&a.name===t.name){this.removeEventListener(a.type,a.listener,a.options),this.addEventListener(a.type,a.listener=s,a.options=n),a.value=e;return}}this.addEventListener(t.type,s,n),a={type:t.type,name:t.name,value:e,listener:s,options:n},i?i.push(a):this.__on=[a]}}function qs(t,e,n){var i=Gs(t+""),a,s=i.length,r;if(arguments.length<2){var o=this.node().__on;if(o){for(var c=0,l=o.length,d;c<l;++c)for(a=0,d=o[c];a<s;++a)if((r=i[a]).type===d.type&&r.name===d.name)return d.value}return}for(o=e?Vs:Ys,a=0;a<s;++a)this.each(o(i[a],e,n));return this}function ui(t,e,n){var i=ri(t),a=i.CustomEvent;typeof a=="function"?a=new a(e,n):(a=i.document.createEvent("Event"),n?(a.initEvent(e,n.bubbles,n.cancelable),a.detail=n.detail):a.initEvent(e,!1,!1)),t.dispatchEvent(a)}function Us(t,e){return function(){return ui(this,t,e)}}function Xs(t,e){return function(){return ui(this,t,e.apply(this,arguments))}}function Ws(t,e){return this.each((typeof e=="function"?Xs:Us)(t,e))}function*Js(){for(var t=this._groups,e=0,n=t.length;e<n;++e)for(var i=t[e],a=0,s=i.length,r;a<s;++a)(r=i[a])&&(yield r)}var pi=[null];function rt(t,e){this._groups=t,this._parents=e}function Vt(){return new rt([[document.documentElement]],pi)}function Ks(){return this}rt.prototype=Vt.prototype={constructor:rt,select:Ea,selectAll:Ta,selectChild:Ca,selectChildren:Pa,filter:Ra,data:Fa,enter:Oa,exit:Ya,join:Va,merge:qa,selection:Ks,order:Ua,sort:Xa,call:Ja,nodes:Ka,node:Qa,size:Za,empty:ts,each:es,attr:ls,style:ps,property:gs,classed:_s,text:$s,html:Ss,raise:Ns,lower:Ls,append:Ms,insert:Ps,remove:Os,clone:Hs,datum:js,on:qs,dispatch:Ws,[Symbol.iterator]:Js};function Z(t){return typeof t=="string"?new rt([[document.querySelector(t)]],[document.documentElement]):new rt([[t]],pi)}function Qs(t){let e;for(;e=t.sourceEvent;)t=e;return t}function mt(t,e){if(t=Qs(t),e===void 0&&(e=t.currentTarget),e){var n=e.ownerSVGElement||e;if(n.createSVGPoint){var i=n.createSVGPoint();return i.x=t.clientX,i.y=t.clientY,i=i.matrixTransform(e.getScreenCTM().inverse()),[i.x,i.y]}if(e.getBoundingClientRect){var a=e.getBoundingClientRect();return[t.clientX-a.left-e.clientLeft,t.clientY-a.top-e.clientTop]}}return[t.pageX,t.pageY]}const Zs={passive:!1},zt={capture:!0,passive:!1};function $e(t){t.stopImmediatePropagation()}function At(t){t.preventDefault(),t.stopImmediatePropagation()}function fi(t){var e=t.document.documentElement,n=Z(t).on("dragstart.drag",At,zt);"onselectstart"in e?n.on("selectstart.drag",At,zt):(e.__noselect=e.style.MozUserSelect,e.style.MozUserSelect="none")}function hi(t,e){var n=t.document.documentElement,i=Z(t).on("dragstart.drag",null);e&&(i.on("click.drag",At,zt),setTimeout(function(){i.on("click.drag",null)},0)),"onselectstart"in n?i.on("selectstart.drag",null):(n.style.MozUserSelect=n.__noselect,delete n.__noselect)}const Wt=t=>()=>t;function Pe(t,{sourceEvent:e,subject:n,target:i,identifier:a,active:s,x:r,y:o,dx:c,dy:l,dispatch:d}){Object.defineProperties(this,{type:{value:t,enumerable:!0,configurable:!0},sourceEvent:{value:e,enumerable:!0,configurable:!0},subject:{value:n,enumerable:!0,configurable:!0},target:{value:i,enumerable:!0,configurable:!0},identifier:{value:a,enumerable:!0,configurable:!0},active:{value:s,enumerable:!0,configurable:!0},x:{value:r,enumerable:!0,configurable:!0},y:{value:o,enumerable:!0,configurable:!0},dx:{value:c,enumerable:!0,configurable:!0},dy:{value:l,enumerable:!0,configurable:!0},_:{value:d}})}Pe.prototype.on=function(){var t=this._.on.apply(this._,arguments);return t===this._?this:t};function tr(t){return!t.ctrlKey&&!t.button}function er(){return this.parentNode}function nr(t,e){return e??{x:t.x,y:t.y}}function ir(){return navigator.maxTouchPoints||"ontouchstart"in this}function ar(){var t=tr,e=er,n=nr,i=ir,a={},s=Yt("start","drag","end"),r=0,o,c,l,d,_=0;function f(v){v.on("mousedown.drag",h).filter(i).on("touchstart.drag",x).on("touchmove.drag",g,Zs).on("touchend.drag touchcancel.drag",k).style("touch-action","none").style("-webkit-tap-highlight-color","rgba(0,0,0,0)")}function h(v,C){if(!(d||!t.call(this,v,C))){var b=N(this,e.call(this,v,C),v,C,"mouse");b&&(Z(v.view).on("mousemove.drag",E,zt).on("mouseup.drag",y,zt),fi(v.view),$e(v),l=!1,o=v.clientX,c=v.clientY,b("start",v))}}function E(v){if(At(v),!l){var C=v.clientX-o,b=v.clientY-c;l=C*C+b*b>_}a.mouse("drag",v)}function y(v){Z(v.view).on("mousemove.drag mouseup.drag",null),hi(v.view,l),At(v),a.mouse("end",v)}function x(v,C){if(t.call(this,v,C)){var b=v.changedTouches,I=e.call(this,v,C),M=b.length,B,T;for(B=0;B<M;++B)(T=N(this,I,v,C,b[B].identifier,b[B]))&&($e(v),T("start",v,b[B]))}}function g(v){var C=v.changedTouches,b=C.length,I,M;for(I=0;I<b;++I)(M=a[C[I].identifier])&&(At(v),M("drag",v,C[I]))}function k(v){var C=v.changedTouches,b=C.length,I,M;for(d&&clearTimeout(d),d=setTimeout(function(){d=null},500),I=0;I<b;++I)(M=a[C[I].identifier])&&($e(v),M("end",v,C[I]))}function N(v,C,b,I,M,B){var T=s.copy(),R=mt(B||b,C),j,Y,m;if((m=n.call(v,new Pe("beforestart",{sourceEvent:b,target:f,identifier:M,active:r,x:R[0],y:R[1],dx:0,dy:0,dispatch:T}),I))!=null)return j=m.x-R[0]||0,Y=m.y-R[1]||0,function u(p,w,A){var L=R,P;switch(p){case"start":a[M]=u,P=r++;break;case"end":delete a[M],--r;case"drag":R=mt(A||w,C),P=r;break}T.call(p,v,new Pe(p,{sourceEvent:w,subject:m,target:f,identifier:M,active:P,x:R[0]+j,y:R[1]+Y,dx:R[0]-L[0],dy:R[1]-L[1],dispatch:T}),I)}}return f.filter=function(v){return arguments.length?(t=typeof v=="function"?v:Wt(!!v),f):t},f.container=function(v){return arguments.length?(e=typeof v=="function"?v:Wt(v),f):e},f.subject=function(v){return arguments.length?(n=typeof v=="function"?v:Wt(v),f):n},f.touchable=function(v){return arguments.length?(i=typeof v=="function"?v:Wt(!!v),f):i},f.on=function(){var v=s.on.apply(s,arguments);return v===s?f:v},f.clickDistance=function(v){return arguments.length?(_=(v=+v)*v,f):Math.sqrt(_)},f}function tn(t,e,n){t.prototype=e.prototype=n,n.constructor=t}function mi(t,e){var n=Object.create(t.prototype);for(var i in e)n[i]=e[i];return n}function qt(){}var Ht=.7,ue=1/Ht,Nt="\\s*([+-]?\\d+)\\s*",jt="\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*",pt="\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*",sr=/^#([0-9a-f]{3,8})$/,rr=new RegExp(`^rgb\\(${Nt},${Nt},${Nt}\\)$`),or=new RegExp(`^rgb\\(${pt},${pt},${pt}\\)$`),lr=new RegExp(`^rgba\\(${Nt},${Nt},${Nt},${jt}\\)$`),cr=new RegExp(`^rgba\\(${pt},${pt},${pt},${jt}\\)$`),dr=new RegExp(`^hsl\\(${jt},${pt},${pt}\\)$`),ur=new RegExp(`^hsla\\(${jt},${pt},${pt},${jt}\\)$`),bn={aliceblue:15792383,antiquewhite:16444375,aqua:65535,aquamarine:8388564,azure:15794175,beige:16119260,bisque:16770244,black:0,blanchedalmond:16772045,blue:255,blueviolet:9055202,brown:10824234,burlywood:14596231,cadetblue:6266528,chartreuse:8388352,chocolate:13789470,coral:16744272,cornflowerblue:6591981,cornsilk:16775388,crimson:14423100,cyan:65535,darkblue:139,darkcyan:35723,darkgoldenrod:12092939,darkgray:11119017,darkgreen:25600,darkgrey:11119017,darkkhaki:12433259,darkmagenta:9109643,darkolivegreen:5597999,darkorange:16747520,darkorchid:10040012,darkred:9109504,darksalmon:15308410,darkseagreen:9419919,darkslateblue:4734347,darkslategray:3100495,darkslategrey:3100495,darkturquoise:52945,darkviolet:9699539,deeppink:16716947,deepskyblue:49151,dimgray:6908265,dimgrey:6908265,dodgerblue:2003199,firebrick:11674146,floralwhite:16775920,forestgreen:2263842,fuchsia:16711935,gainsboro:14474460,ghostwhite:16316671,gold:16766720,goldenrod:14329120,gray:8421504,green:32768,greenyellow:11403055,grey:8421504,honeydew:15794160,hotpink:16738740,indianred:13458524,indigo:4915330,ivory:16777200,khaki:15787660,lavender:15132410,lavenderblush:16773365,lawngreen:8190976,lemonchiffon:16775885,lightblue:11393254,lightcoral:15761536,lightcyan:14745599,lightgoldenrodyellow:16448210,lightgray:13882323,lightgreen:9498256,lightgrey:13882323,lightpink:16758465,lightsalmon:16752762,lightseagreen:2142890,lightskyblue:8900346,lightslategray:7833753,lightslategrey:7833753,lightsteelblue:11584734,lightyellow:16777184,lime:65280,limegreen:3329330,linen:16445670,magenta:16711935,maroon:8388608,mediumaquamarine:6737322,mediumblue:205,mediumorchid:12211667,mediumpurple:9662683,mediumseagreen:3978097,mediumslateblue:8087790,mediumspringgreen:64154,mediumturquoise:4772300,mediumvioletred:13047173,midnightblue:1644912,mintcream:16121850,mistyrose:16770273,moccasin:16770229,navajowhite:16768685,navy:128,oldlace:16643558,olive:8421376,olivedrab:7048739,orange:16753920,orangered:16729344,orchid:14315734,palegoldenrod:15657130,palegreen:10025880,paleturquoise:11529966,palevioletred:14381203,papayawhip:16773077,peachpuff:16767673,peru:13468991,pink:16761035,plum:14524637,powderblue:11591910,purple:8388736,rebeccapurple:6697881,red:16711680,rosybrown:12357519,royalblue:4286945,saddlebrown:9127187,salmon:16416882,sandybrown:16032864,seagreen:3050327,seashell:16774638,sienna:10506797,silver:12632256,skyblue:8900331,slateblue:6970061,slategray:7372944,slategrey:7372944,snow:16775930,springgreen:65407,steelblue:4620980,tan:13808780,teal:32896,thistle:14204888,tomato:16737095,turquoise:4251856,violet:15631086,wheat:16113331,white:16777215,whitesmoke:16119285,yellow:16776960,yellowgreen:10145074};tn(qt,Ft,{copy(t){return Object.assign(new this.constructor,this,t)},displayable(){return this.rgb().displayable()},hex:_n,formatHex:_n,formatHex8:pr,formatHsl:fr,formatRgb:xn,toString:xn});function _n(){return this.rgb().formatHex()}function pr(){return this.rgb().formatHex8()}function fr(){return gi(this).formatHsl()}function xn(){return this.rgb().formatRgb()}function Ft(t){var e,n;return t=(t+"").trim().toLowerCase(),(e=sr.exec(t))?(n=e[1].length,e=parseInt(e[1],16),n===6?wn(e):n===3?new st(e>>8&15|e>>4&240,e>>4&15|e&240,(e&15)<<4|e&15,1):n===8?Jt(e>>24&255,e>>16&255,e>>8&255,(e&255)/255):n===4?Jt(e>>12&15|e>>8&240,e>>8&15|e>>4&240,e>>4&15|e&240,((e&15)<<4|e&15)/255):null):(e=rr.exec(t))?new st(e[1],e[2],e[3],1):(e=or.exec(t))?new st(e[1]*255/100,e[2]*255/100,e[3]*255/100,1):(e=lr.exec(t))?Jt(e[1],e[2],e[3],e[4]):(e=cr.exec(t))?Jt(e[1]*255/100,e[2]*255/100,e[3]*255/100,e[4]):(e=dr.exec(t))?kn(e[1],e[2]/100,e[3]/100,1):(e=ur.exec(t))?kn(e[1],e[2]/100,e[3]/100,e[4]):bn.hasOwnProperty(t)?wn(bn[t]):t==="transparent"?new st(NaN,NaN,NaN,0):null}function wn(t){return new st(t>>16&255,t>>8&255,t&255,1)}function Jt(t,e,n,i){return i<=0&&(t=e=n=NaN),new st(t,e,n,i)}function hr(t){return t instanceof qt||(t=Ft(t)),t?(t=t.rgb(),new st(t.r,t.g,t.b,t.opacity)):new st}function Re(t,e,n,i){return arguments.length===1?hr(t):new st(t,e,n,i??1)}function st(t,e,n,i){this.r=+t,this.g=+e,this.b=+n,this.opacity=+i}tn(st,Re,mi(qt,{brighter(t){return t=t==null?ue:Math.pow(ue,t),new st(this.r*t,this.g*t,this.b*t,this.opacity)},darker(t){return t=t==null?Ht:Math.pow(Ht,t),new st(this.r*t,this.g*t,this.b*t,this.opacity)},rgb(){return this},clamp(){return new st(kt(this.r),kt(this.g),kt(this.b),pe(this.opacity))},displayable(){return-.5<=this.r&&this.r<255.5&&-.5<=this.g&&this.g<255.5&&-.5<=this.b&&this.b<255.5&&0<=this.opacity&&this.opacity<=1},hex:En,formatHex:En,formatHex8:mr,formatRgb:$n,toString:$n}));function En(){return`#${Et(this.r)}${Et(this.g)}${Et(this.b)}`}function mr(){return`#${Et(this.r)}${Et(this.g)}${Et(this.b)}${Et((isNaN(this.opacity)?1:this.opacity)*255)}`}function $n(){const t=pe(this.opacity);return`${t===1?"rgb(":"rgba("}${kt(this.r)}, ${kt(this.g)}, ${kt(this.b)}${t===1?")":`, ${t})`}`}function pe(t){return isNaN(t)?1:Math.max(0,Math.min(1,t))}function kt(t){return Math.max(0,Math.min(255,Math.round(t)||0))}function Et(t){return t=kt(t),(t<16?"0":"")+t.toString(16)}function kn(t,e,n,i){return i<=0?t=e=n=NaN:n<=0||n>=1?t=e=NaN:e<=0&&(t=NaN),new ot(t,e,n,i)}function gi(t){if(t instanceof ot)return new ot(t.h,t.s,t.l,t.opacity);if(t instanceof qt||(t=Ft(t)),!t)return new ot;if(t instanceof ot)return t;t=t.rgb();var e=t.r/255,n=t.g/255,i=t.b/255,a=Math.min(e,n,i),s=Math.max(e,n,i),r=NaN,o=s-a,c=(s+a)/2;return o?(e===s?r=(n-i)/o+(n<i)*6:n===s?r=(i-e)/o+2:r=(e-n)/o+4,o/=c<.5?s+a:2-s-a,r*=60):o=c>0&&c<1?0:r,new ot(r,o,c,t.opacity)}function gr(t,e,n,i){return arguments.length===1?gi(t):new ot(t,e,n,i??1)}function ot(t,e,n,i){this.h=+t,this.s=+e,this.l=+n,this.opacity=+i}tn(ot,gr,mi(qt,{brighter(t){return t=t==null?ue:Math.pow(ue,t),new ot(this.h,this.s,this.l*t,this.opacity)},darker(t){return t=t==null?Ht:Math.pow(Ht,t),new ot(this.h,this.s,this.l*t,this.opacity)},rgb(){var t=this.h%360+(this.h<0)*360,e=isNaN(t)||isNaN(this.s)?0:this.s,n=this.l,i=n+(n<.5?n:1-n)*e,a=2*n-i;return new st(ke(t>=240?t-240:t+120,a,i),ke(t,a,i),ke(t<120?t+240:t-120,a,i),this.opacity)},clamp(){return new ot(In(this.h),Kt(this.s),Kt(this.l),pe(this.opacity))},displayable(){return(0<=this.s&&this.s<=1||isNaN(this.s))&&0<=this.l&&this.l<=1&&0<=this.opacity&&this.opacity<=1},formatHsl(){const t=pe(this.opacity);return`${t===1?"hsl(":"hsla("}${In(this.h)}, ${Kt(this.s)*100}%, ${Kt(this.l)*100}%${t===1?")":`, ${t})`}`}}));function In(t){return t=(t||0)%360,t<0?t+360:t}function Kt(t){return Math.max(0,Math.min(1,t||0))}function ke(t,e,n){return(t<60?e+(n-e)*t/60:t<180?n:t<240?e+(n-e)*(240-t)/60:e)*255}const vi=t=>()=>t;function vr(t,e){return function(n){return t+n*e}}function yr(t,e,n){return t=Math.pow(t,n),e=Math.pow(e,n)-t,n=1/n,function(i){return Math.pow(t+i*e,n)}}function br(t){return(t=+t)==1?yi:function(e,n){return n-e?yr(e,n,t):vi(isNaN(e)?n:e)}}function yi(t,e){var n=e-t;return n?vr(t,n):vi(isNaN(t)?e:t)}const Tn=function t(e){var n=br(e);function i(a,s){var r=n((a=Re(a)).r,(s=Re(s)).r),o=n(a.g,s.g),c=n(a.b,s.b),l=yi(a.opacity,s.opacity);return function(d){return a.r=r(d),a.g=o(d),a.b=c(d),a.opacity=l(d),a+""}}return i.gamma=t,i}(1);function yt(t,e){return t=+t,e=+e,function(n){return t*(1-n)+e*n}}var Oe=/[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,Ie=new RegExp(Oe.source,"g");function _r(t){return function(){return t}}function xr(t){return function(e){return t(e)+""}}function wr(t,e){var n=Oe.lastIndex=Ie.lastIndex=0,i,a,s,r=-1,o=[],c=[];for(t=t+"",e=e+"";(i=Oe.exec(t))&&(a=Ie.exec(e));)(s=a.index)>n&&(s=e.slice(n,s),o[r]?o[r]+=s:o[++r]=s),(i=i[0])===(a=a[0])?o[r]?o[r]+=a:o[++r]=a:(o[++r]=null,c.push({i:r,x:yt(i,a)})),n=Ie.lastIndex;return n<e.length&&(s=e.slice(n),o[r]?o[r]+=s:o[++r]=s),o.length<2?c[0]?xr(c[0].x):_r(e):(e=c.length,function(l){for(var d=0,_;d<e;++d)o[(_=c[d]).i]=_.x(l);return o.join("")})}var Sn=180/Math.PI,De={translateX:0,translateY:0,rotate:0,skewX:0,scaleX:1,scaleY:1};function bi(t,e,n,i,a,s){var r,o,c;return(r=Math.sqrt(t*t+e*e))&&(t/=r,e/=r),(c=t*n+e*i)&&(n-=t*c,i-=e*c),(o=Math.sqrt(n*n+i*i))&&(n/=o,i/=o,c/=o),t*i<e*n&&(t=-t,e=-e,c=-c,r=-r),{translateX:a,translateY:s,rotate:Math.atan2(e,t)*Sn,skewX:Math.atan(c)*Sn,scaleX:r,scaleY:o}}var Qt;function Er(t){const e=new(typeof DOMMatrix=="function"?DOMMatrix:WebKitCSSMatrix)(t+"");return e.isIdentity?De:bi(e.a,e.b,e.c,e.d,e.e,e.f)}function $r(t){return t==null||(Qt||(Qt=document.createElementNS("http://www.w3.org/2000/svg","g")),Qt.setAttribute("transform",t),!(t=Qt.transform.baseVal.consolidate()))?De:(t=t.matrix,bi(t.a,t.b,t.c,t.d,t.e,t.f))}function _i(t,e,n,i){function a(l){return l.length?l.pop()+" ":""}function s(l,d,_,f,h,E){if(l!==_||d!==f){var y=h.push("translate(",null,e,null,n);E.push({i:y-4,x:yt(l,_)},{i:y-2,x:yt(d,f)})}else(_||f)&&h.push("translate("+_+e+f+n)}function r(l,d,_,f){l!==d?(l-d>180?d+=360:d-l>180&&(l+=360),f.push({i:_.push(a(_)+"rotate(",null,i)-2,x:yt(l,d)})):d&&_.push(a(_)+"rotate("+d+i)}function o(l,d,_,f){l!==d?f.push({i:_.push(a(_)+"skewX(",null,i)-2,x:yt(l,d)}):d&&_.push(a(_)+"skewX("+d+i)}function c(l,d,_,f,h,E){if(l!==_||d!==f){var y=h.push(a(h)+"scale(",null,",",null,")");E.push({i:y-4,x:yt(l,_)},{i:y-2,x:yt(d,f)})}else(_!==1||f!==1)&&h.push(a(h)+"scale("+_+","+f+")")}return function(l,d){var _=[],f=[];return l=t(l),d=t(d),s(l.translateX,l.translateY,d.translateX,d.translateY,_,f),r(l.rotate,d.rotate,_,f),o(l.skewX,d.skewX,_,f),c(l.scaleX,l.scaleY,d.scaleX,d.scaleY,_,f),l=d=null,function(h){for(var E=-1,y=f.length,x;++E<y;)_[(x=f[E]).i]=x.x(h);return _.join("")}}}var kr=_i(Er,"px, ","px)","deg)"),Ir=_i($r,", ",")",")"),Tr=1e-12;function An(t){return((t=Math.exp(t))+1/t)/2}function Sr(t){return((t=Math.exp(t))-1/t)/2}function Ar(t){return((t=Math.exp(2*t))-1)/(t+1)}const Nr=function t(e,n,i){function a(s,r){var o=s[0],c=s[1],l=s[2],d=r[0],_=r[1],f=r[2],h=d-o,E=_-c,y=h*h+E*E,x,g;if(y<Tr)g=Math.log(f/l)/e,x=function(I){return[o+I*h,c+I*E,l*Math.exp(e*I*g)]};else{var k=Math.sqrt(y),N=(f*f-l*l+i*y)/(2*l*n*k),v=(f*f-l*l-i*y)/(2*f*n*k),C=Math.log(Math.sqrt(N*N+1)-N),b=Math.log(Math.sqrt(v*v+1)-v);g=(b-C)/e,x=function(I){var M=I*g,B=An(C),T=l/(n*k)*(B*Ar(e*M+C)-Sr(C));return[o+T*h,c+T*E,l*B/An(e*M+C)]}}return x.duration=g*1e3*e/Math.SQRT2,x}return a.rho=function(s){var r=Math.max(.001,+s),o=r*r,c=o*o;return t(r,o,c)},a}(Math.SQRT2,2,4);var Lt=0,Rt=0,Bt=0,xi=1e3,fe,Ot,he=0,It=0,be=0,Gt=typeof performance=="object"&&performance.now?performance:Date,wi=typeof window=="object"&&window.requestAnimationFrame?window.requestAnimationFrame.bind(window):function(t){setTimeout(t,17)};function en(){return It||(wi(Cr),It=Gt.now()+be)}function Cr(){It=0}function me(){this._call=this._time=this._next=null}me.prototype=nn.prototype={constructor:me,restart:function(t,e,n){if(typeof t!="function")throw new TypeError("callback is not a function");n=(n==null?en():+n)+(e==null?0:+e),!this._next&&Ot!==this&&(Ot?Ot._next=this:fe=this,Ot=this),this._call=t,this._time=n,ze()},stop:function(){this._call&&(this._call=null,this._time=1/0,ze())}};function nn(t,e,n){var i=new me;return i.restart(t,e,n),i}function Lr(){en(),++Lt;for(var t=fe,e;t;)(e=It-t._time)>=0&&t._call.call(void 0,e),t=t._next;--Lt}function Nn(){It=(he=Gt.now())+be,Lt=Rt=0;try{Lr()}finally{Lt=0,Br(),It=0}}function Mr(){var t=Gt.now(),e=t-he;e>xi&&(be-=e,he=t)}function Br(){for(var t,e=fe,n,i=1/0;e;)e._call?(i>e._time&&(i=e._time),t=e,e=e._next):(n=e._next,e._next=null,e=t?t._next=n:fe=n);Ot=t,ze(i)}function ze(t){if(!Lt){Rt&&(Rt=clearTimeout(Rt));var e=t-It;e>24?(t<1/0&&(Rt=setTimeout(Nn,t-Gt.now()-be)),Bt&&(Bt=clearInterval(Bt))):(Bt||(he=Gt.now(),Bt=setInterval(Mr,xi)),Lt=1,wi(Nn))}}function Cn(t,e,n){var i=new me;return e=e==null?0:+e,i.restart(a=>{i.stop(),t(a+e)},e,n),i}var Pr=Yt("start","end","cancel","interrupt"),Rr=[],Ei=0,Ln=1,He=2,oe=3,Mn=4,je=5,le=6;function _e(t,e,n,i,a,s){var r=t.__transition;if(!r)t.__transition={};else if(n in r)return;Or(t,n,{name:e,index:i,group:a,on:Pr,tween:Rr,time:s.time,delay:s.delay,duration:s.duration,ease:s.ease,timer:null,state:Ei})}function an(t,e){var n=lt(t,e);if(n.state>Ei)throw new Error("too late; already scheduled");return n}function ft(t,e){var n=lt(t,e);if(n.state>oe)throw new Error("too late; already running");return n}function lt(t,e){var n=t.__transition;if(!n||!(n=n[e]))throw new Error("transition not found");return n}function Or(t,e,n){var i=t.__transition,a;i[e]=n,n.timer=nn(s,0,n.time);function s(l){n.state=Ln,n.timer.restart(r,n.delay,n.time),n.delay<=l&&r(l-n.delay)}function r(l){var d,_,f,h;if(n.state!==Ln)return c();for(d in i)if(h=i[d],h.name===n.name){if(h.state===oe)return Cn(r);h.state===Mn?(h.state=le,h.timer.stop(),h.on.call("interrupt",t,t.__data__,h.index,h.group),delete i[d]):+d<e&&(h.state=le,h.timer.stop(),h.on.call("cancel",t,t.__data__,h.index,h.group),delete i[d])}if(Cn(function(){n.state===oe&&(n.state=Mn,n.timer.restart(o,n.delay,n.time),o(l))}),n.state=He,n.on.call("start",t,t.__data__,n.index,n.group),n.state===He){for(n.state=oe,a=new Array(f=n.tween.length),d=0,_=-1;d<f;++d)(h=n.tween[d].value.call(t,t.__data__,n.index,n.group))&&(a[++_]=h);a.length=_+1}}function o(l){for(var d=l<n.duration?n.ease.call(null,l/n.duration):(n.timer.restart(c),n.state=je,1),_=-1,f=a.length;++_<f;)a[_].call(t,d);n.state===je&&(n.on.call("end",t,t.__data__,n.index,n.group),c())}function c(){n.state=le,n.timer.stop(),delete i[e];for(var l in i)return;delete t.__transition}}function ce(t,e){var n=t.__transition,i,a,s=!0,r;if(n){e=e==null?null:e+"";for(r in n){if((i=n[r]).name!==e){s=!1;continue}a=i.state>He&&i.state<je,i.state=le,i.timer.stop(),i.on.call(a?"interrupt":"cancel",t,t.__data__,i.index,i.group),delete n[r]}s&&delete t.__transition}}function Dr(t){return this.each(function(){ce(this,t)})}function zr(t,e){var n,i;return function(){var a=ft(this,t),s=a.tween;if(s!==n){i=n=s;for(var r=0,o=i.length;r<o;++r)if(i[r].name===e){i=i.slice(),i.splice(r,1);break}}a.tween=i}}function Hr(t,e,n){var i,a;if(typeof n!="function")throw new Error;return function(){var s=ft(this,t),r=s.tween;if(r!==i){a=(i=r).slice();for(var o={name:e,value:n},c=0,l=a.length;c<l;++c)if(a[c].name===e){a[c]=o;break}c===l&&a.push(o)}s.tween=a}}function jr(t,e){var n=this._id;if(t+="",arguments.length<2){for(var i=lt(this.node(),n).tween,a=0,s=i.length,r;a<s;++a)if((r=i[a]).name===t)return r.value;return null}return this.each((e==null?zr:Hr)(n,t,e))}function sn(t,e,n){var i=t._id;return t.each(function(){var a=ft(this,i);(a.value||(a.value={}))[e]=n.apply(this,arguments)}),function(a){return lt(a,i).value[e]}}function $i(t,e){var n;return(typeof e=="number"?yt:e instanceof Ft?Tn:(n=Ft(e))?(e=n,Tn):wr)(t,e)}function Fr(t){return function(){this.removeAttribute(t)}}function Gr(t){return function(){this.removeAttributeNS(t.space,t.local)}}function Yr(t,e,n){var i,a=n+"",s;return function(){var r=this.getAttribute(t);return r===a?null:r===i?s:s=e(i=r,n)}}function Vr(t,e,n){var i,a=n+"",s;return function(){var r=this.getAttributeNS(t.space,t.local);return r===a?null:r===i?s:s=e(i=r,n)}}function qr(t,e,n){var i,a,s;return function(){var r,o=n(this),c;return o==null?void this.removeAttribute(t):(r=this.getAttribute(t),c=o+"",r===c?null:r===i&&c===a?s:(a=c,s=e(i=r,o)))}}function Ur(t,e,n){var i,a,s;return function(){var r,o=n(this),c;return o==null?void this.removeAttributeNS(t.space,t.local):(r=this.getAttributeNS(t.space,t.local),c=o+"",r===c?null:r===i&&c===a?s:(a=c,s=e(i=r,o)))}}function Xr(t,e){var n=ye(t),i=n==="transform"?Ir:$i;return this.attrTween(t,typeof e=="function"?(n.local?Ur:qr)(n,i,sn(this,"attr."+t,e)):e==null?(n.local?Gr:Fr)(n):(n.local?Vr:Yr)(n,i,e))}function Wr(t,e){return function(n){this.setAttribute(t,e.call(this,n))}}function Jr(t,e){return function(n){this.setAttributeNS(t.space,t.local,e.call(this,n))}}function Kr(t,e){var n,i;function a(){var s=e.apply(this,arguments);return s!==i&&(n=(i=s)&&Jr(t,s)),n}return a._value=e,a}function Qr(t,e){var n,i;function a(){var s=e.apply(this,arguments);return s!==i&&(n=(i=s)&&Wr(t,s)),n}return a._value=e,a}function Zr(t,e){var n="attr."+t;if(arguments.length<2)return(n=this.tween(n))&&n._value;if(e==null)return this.tween(n,null);if(typeof e!="function")throw new Error;var i=ye(t);return this.tween(n,(i.local?Kr:Qr)(i,e))}function to(t,e){return function(){an(this,t).delay=+e.apply(this,arguments)}}function eo(t,e){return e=+e,function(){an(this,t).delay=e}}function no(t){var e=this._id;return arguments.length?this.each((typeof t=="function"?to:eo)(e,t)):lt(this.node(),e).delay}function io(t,e){return function(){ft(this,t).duration=+e.apply(this,arguments)}}function ao(t,e){return e=+e,function(){ft(this,t).duration=e}}function so(t){var e=this._id;return arguments.length?this.each((typeof t=="function"?io:ao)(e,t)):lt(this.node(),e).duration}function ro(t,e){if(typeof e!="function")throw new Error;return function(){ft(this,t).ease=e}}function oo(t){var e=this._id;return arguments.length?this.each(ro(e,t)):lt(this.node(),e).ease}function lo(t,e){return function(){var n=e.apply(this,arguments);if(typeof n!="function")throw new Error;ft(this,t).ease=n}}function co(t){if(typeof t!="function")throw new Error;return this.each(lo(this._id,t))}function uo(t){typeof t!="function"&&(t=ii(t));for(var e=this._groups,n=e.length,i=new Array(n),a=0;a<n;++a)for(var s=e[a],r=s.length,o=i[a]=[],c,l=0;l<r;++l)(c=s[l])&&t.call(c,c.__data__,l,s)&&o.push(c);return new vt(i,this._parents,this._name,this._id)}function po(t){if(t._id!==this._id)throw new Error;for(var e=this._groups,n=t._groups,i=e.length,a=n.length,s=Math.min(i,a),r=new Array(i),o=0;o<s;++o)for(var c=e[o],l=n[o],d=c.length,_=r[o]=new Array(d),f,h=0;h<d;++h)(f=c[h]||l[h])&&(_[h]=f);for(;o<i;++o)r[o]=e[o];return new vt(r,this._parents,this._name,this._id)}function fo(t){return(t+"").trim().split(/^|\s+/).every(function(e){var n=e.indexOf(".");return n>=0&&(e=e.slice(0,n)),!e||e==="start"})}function ho(t,e,n){var i,a,s=fo(e)?an:ft;return function(){var r=s(this,t),o=r.on;o!==i&&(a=(i=o).copy()).on(e,n),r.on=a}}function mo(t,e){var n=this._id;return arguments.length<2?lt(this.node(),n).on.on(t):this.each(ho(n,t,e))}function go(t){return function(){var e=this.parentNode;for(var n in this.__transition)if(+n!==t)return;e&&e.removeChild(this)}}function vo(){return this.on("end.remove",go(this._id))}function yo(t){var e=this._name,n=this._id;typeof t!="function"&&(t=Qe(t));for(var i=this._groups,a=i.length,s=new Array(a),r=0;r<a;++r)for(var o=i[r],c=o.length,l=s[r]=new Array(c),d,_,f=0;f<c;++f)(d=o[f])&&(_=t.call(d,d.__data__,f,o))&&("__data__"in d&&(_.__data__=d.__data__),l[f]=_,_e(l[f],e,n,f,l,lt(d,n)));return new vt(s,this._parents,e,n)}function bo(t){var e=this._name,n=this._id;typeof t!="function"&&(t=ni(t));for(var i=this._groups,a=i.length,s=[],r=[],o=0;o<a;++o)for(var c=i[o],l=c.length,d,_=0;_<l;++_)if(d=c[_]){for(var f=t.call(d,d.__data__,_,c),h,E=lt(d,n),y=0,x=f.length;y<x;++y)(h=f[y])&&_e(h,e,n,y,f,E);s.push(f),r.push(d)}return new vt(s,r,e,n)}var _o=Vt.prototype.constructor;function xo(){return new _o(this._groups,this._parents)}function wo(t,e){var n,i,a;return function(){var s=Ct(this,t),r=(this.style.removeProperty(t),Ct(this,t));return s===r?null:s===n&&r===i?a:a=e(n=s,i=r)}}function ki(t){return function(){this.style.removeProperty(t)}}function Eo(t,e,n){var i,a=n+"",s;return function(){var r=Ct(this,t);return r===a?null:r===i?s:s=e(i=r,n)}}function $o(t,e,n){var i,a,s;return function(){var r=Ct(this,t),o=n(this),c=o+"";return o==null&&(c=o=(this.style.removeProperty(t),Ct(this,t))),r===c?null:r===i&&c===a?s:(a=c,s=e(i=r,o))}}function ko(t,e){var n,i,a,s="style."+e,r="end."+s,o;return function(){var c=ft(this,t),l=c.on,d=c.value[s]==null?o||(o=ki(e)):void 0;(l!==n||a!==d)&&(i=(n=l).copy()).on(r,a=d),c.on=i}}function Io(t,e,n){var i=(t+="")=="transform"?kr:$i;return e==null?this.styleTween(t,wo(t,i)).on("end.style."+t,ki(t)):typeof e=="function"?this.styleTween(t,$o(t,i,sn(this,"style."+t,e))).each(ko(this._id,t)):this.styleTween(t,Eo(t,i,e),n).on("end.style."+t,null)}function To(t,e,n){return function(i){this.style.setProperty(t,e.call(this,i),n)}}function So(t,e,n){var i,a;function s(){var r=e.apply(this,arguments);return r!==a&&(i=(a=r)&&To(t,r,n)),i}return s._value=e,s}function Ao(t,e,n){var i="style."+(t+="");if(arguments.length<2)return(i=this.tween(i))&&i._value;if(e==null)return this.tween(i,null);if(typeof e!="function")throw new Error;return this.tween(i,So(t,e,n??""))}function No(t){return function(){this.textContent=t}}function Co(t){return function(){var e=t(this);this.textContent=e??""}}function Lo(t){return this.tween("text",typeof t=="function"?Co(sn(this,"text",t)):No(t==null?"":t+""))}function Mo(t){return function(e){this.textContent=t.call(this,e)}}function Bo(t){var e,n;function i(){var a=t.apply(this,arguments);return a!==n&&(e=(n=a)&&Mo(a)),e}return i._value=t,i}function Po(t){var e="text";if(arguments.length<1)return(e=this.tween(e))&&e._value;if(t==null)return this.tween(e,null);if(typeof t!="function")throw new Error;return this.tween(e,Bo(t))}function Ro(){for(var t=this._name,e=this._id,n=Ii(),i=this._groups,a=i.length,s=0;s<a;++s)for(var r=i[s],o=r.length,c,l=0;l<o;++l)if(c=r[l]){var d=lt(c,e);_e(c,t,n,l,r,{time:d.time+d.delay+d.duration,delay:0,duration:d.duration,ease:d.ease})}return new vt(i,this._parents,t,n)}function Oo(){var t,e,n=this,i=n._id,a=n.size();return new Promise(function(s,r){var o={value:r},c={value:function(){--a===0&&s()}};n.each(function(){var l=ft(this,i),d=l.on;d!==t&&(e=(t=d).copy(),e._.cancel.push(o),e._.interrupt.push(o),e._.end.push(c)),l.on=e}),a===0&&s()})}var Do=0;function vt(t,e,n,i){this._groups=t,this._parents=e,this._name=n,this._id=i}function Ii(){return++Do}var ht=Vt.prototype;vt.prototype={constructor:vt,select:yo,selectAll:bo,selectChild:ht.selectChild,selectChildren:ht.selectChildren,filter:uo,merge:po,selection:xo,transition:Ro,call:ht.call,nodes:ht.nodes,node:ht.node,size:ht.size,empty:ht.empty,each:ht.each,on:mo,attr:Xr,attrTween:Zr,style:Io,styleTween:Ao,text:Lo,textTween:Po,remove:vo,tween:jr,delay:no,duration:so,ease:oo,easeVarying:co,end:Oo,[Symbol.iterator]:ht[Symbol.iterator]};function zo(t){return((t*=2)<=1?t*t*t:(t-=2)*t*t+2)/2}var Ho={time:null,delay:0,duration:250,ease:zo};function jo(t,e){for(var n;!(n=t.__transition)||!(n=n[e]);)if(!(t=t.parentNode))throw new Error(`transition ${e} not found`);return n}function Fo(t){var e,n;t instanceof vt?(e=t._id,t=t._name):(e=Ii(),(n=Ho).time=en(),t=t==null?null:t+"");for(var i=this._groups,a=i.length,s=0;s<a;++s)for(var r=i[s],o=r.length,c,l=0;l<o;++l)(c=r[l])&&_e(c,t,e,l,r,n||jo(c,e));return new vt(i,this._parents,t,e)}Vt.prototype.interrupt=Dr;Vt.prototype.transition=Fo;function Go(t,e){var n,i=1;t==null&&(t=0),e==null&&(e=0);function a(){var s,r=n.length,o,c=0,l=0;for(s=0;s<r;++s)o=n[s],c+=o.x,l+=o.y;for(c=(c/r-t)*i,l=(l/r-e)*i,s=0;s<r;++s)o=n[s],o.x-=c,o.y-=l}return a.initialize=function(s){n=s},a.x=function(s){return arguments.length?(t=+s,a):t},a.y=function(s){return arguments.length?(e=+s,a):e},a.strength=function(s){return arguments.length?(i=+s,a):i},a}function Yo(t){const e=+this._x.call(null,t),n=+this._y.call(null,t);return Ti(this.cover(e,n),e,n,t)}function Ti(t,e,n,i){if(isNaN(e)||isNaN(n))return t;var a,s=t._root,r={data:i},o=t._x0,c=t._y0,l=t._x1,d=t._y1,_,f,h,E,y,x,g,k;if(!s)return t._root=r,t;for(;s.length;)if((y=e>=(_=(o+l)/2))?o=_:l=_,(x=n>=(f=(c+d)/2))?c=f:d=f,a=s,!(s=s[g=x<<1|y]))return a[g]=r,t;if(h=+t._x.call(null,s.data),E=+t._y.call(null,s.data),e===h&&n===E)return r.next=s,a?a[g]=r:t._root=r,t;do a=a?a[g]=new Array(4):t._root=new Array(4),(y=e>=(_=(o+l)/2))?o=_:l=_,(x=n>=(f=(c+d)/2))?c=f:d=f;while((g=x<<1|y)===(k=(E>=f)<<1|h>=_));return a[k]=s,a[g]=r,t}function Vo(t){var e,n,i=t.length,a,s,r=new Array(i),o=new Array(i),c=1/0,l=1/0,d=-1/0,_=-1/0;for(n=0;n<i;++n)isNaN(a=+this._x.call(null,e=t[n]))||isNaN(s=+this._y.call(null,e))||(r[n]=a,o[n]=s,a<c&&(c=a),a>d&&(d=a),s<l&&(l=s),s>_&&(_=s));if(c>d||l>_)return this;for(this.cover(c,l).cover(d,_),n=0;n<i;++n)Ti(this,r[n],o[n],t[n]);return this}function qo(t,e){if(isNaN(t=+t)||isNaN(e=+e))return this;var n=this._x0,i=this._y0,a=this._x1,s=this._y1;if(isNaN(n))a=(n=Math.floor(t))+1,s=(i=Math.floor(e))+1;else{for(var r=a-n||1,o=this._root,c,l;n>t||t>=a||i>e||e>=s;)switch(l=(e<i)<<1|t<n,c=new Array(4),c[l]=o,o=c,r*=2,l){case 0:a=n+r,s=i+r;break;case 1:n=a-r,s=i+r;break;case 2:a=n+r,i=s-r;break;case 3:n=a-r,i=s-r;break}this._root&&this._root.length&&(this._root=o)}return this._x0=n,this._y0=i,this._x1=a,this._y1=s,this}function Uo(){var t=[];return this.visit(function(e){if(!e.length)do t.push(e.data);while(e=e.next)}),t}function Xo(t){return arguments.length?this.cover(+t[0][0],+t[0][1]).cover(+t[1][0],+t[1][1]):isNaN(this._x0)?void 0:[[this._x0,this._y0],[this._x1,this._y1]]}function et(t,e,n,i,a){this.node=t,this.x0=e,this.y0=n,this.x1=i,this.y1=a}function Wo(t,e,n){var i,a=this._x0,s=this._y0,r,o,c,l,d=this._x1,_=this._y1,f=[],h=this._root,E,y;for(h&&f.push(new et(h,a,s,d,_)),n==null?n=1/0:(a=t-n,s=e-n,d=t+n,_=e+n,n*=n);E=f.pop();)if(!(!(h=E.node)||(r=E.x0)>d||(o=E.y0)>_||(c=E.x1)<a||(l=E.y1)<s))if(h.length){var x=(r+c)/2,g=(o+l)/2;f.push(new et(h[3],x,g,c,l),new et(h[2],r,g,x,l),new et(h[1],x,o,c,g),new et(h[0],r,o,x,g)),(y=(e>=g)<<1|t>=x)&&(E=f[f.length-1],f[f.length-1]=f[f.length-1-y],f[f.length-1-y]=E)}else{var k=t-+this._x.call(null,h.data),N=e-+this._y.call(null,h.data),v=k*k+N*N;if(v<n){var C=Math.sqrt(n=v);a=t-C,s=e-C,d=t+C,_=e+C,i=h.data}}return i}function Jo(t){if(isNaN(d=+this._x.call(null,t))||isNaN(_=+this._y.call(null,t)))return this;var e,n=this._root,i,a,s,r=this._x0,o=this._y0,c=this._x1,l=this._y1,d,_,f,h,E,y,x,g;if(!n)return this;if(n.length)for(;;){if((E=d>=(f=(r+c)/2))?r=f:c=f,(y=_>=(h=(o+l)/2))?o=h:l=h,e=n,!(n=n[x=y<<1|E]))return this;if(!n.length)break;(e[x+1&3]||e[x+2&3]||e[x+3&3])&&(i=e,g=x)}for(;n.data!==t;)if(a=n,!(n=n.next))return this;return(s=n.next)&&delete n.next,a?(s?a.next=s:delete a.next,this):e?(s?e[x]=s:delete e[x],(n=e[0]||e[1]||e[2]||e[3])&&n===(e[3]||e[2]||e[1]||e[0])&&!n.length&&(i?i[g]=n:this._root=n),this):(this._root=s,this)}function Ko(t){for(var e=0,n=t.length;e<n;++e)this.remove(t[e]);return this}function Qo(){return this._root}function Zo(){var t=0;return this.visit(function(e){if(!e.length)do++t;while(e=e.next)}),t}function tl(t){var e=[],n,i=this._root,a,s,r,o,c;for(i&&e.push(new et(i,this._x0,this._y0,this._x1,this._y1));n=e.pop();)if(!t(i=n.node,s=n.x0,r=n.y0,o=n.x1,c=n.y1)&&i.length){var l=(s+o)/2,d=(r+c)/2;(a=i[3])&&e.push(new et(a,l,d,o,c)),(a=i[2])&&e.push(new et(a,s,d,l,c)),(a=i[1])&&e.push(new et(a,l,r,o,d)),(a=i[0])&&e.push(new et(a,s,r,l,d))}return this}function el(t){var e=[],n=[],i;for(this._root&&e.push(new et(this._root,this._x0,this._y0,this._x1,this._y1));i=e.pop();){var a=i.node;if(a.length){var s,r=i.x0,o=i.y0,c=i.x1,l=i.y1,d=(r+c)/2,_=(o+l)/2;(s=a[0])&&e.push(new et(s,r,o,d,_)),(s=a[1])&&e.push(new et(s,d,o,c,_)),(s=a[2])&&e.push(new et(s,r,_,d,l)),(s=a[3])&&e.push(new et(s,d,_,c,l))}n.push(i)}for(;i=n.pop();)t(i.node,i.x0,i.y0,i.x1,i.y1);return this}function nl(t){return t[0]}function il(t){return arguments.length?(this._x=t,this):this._x}function al(t){return t[1]}function sl(t){return arguments.length?(this._y=t,this):this._y}function rn(t,e,n){var i=new on(e??nl,n??al,NaN,NaN,NaN,NaN);return t==null?i:i.addAll(t)}function on(t,e,n,i,a,s){this._x=t,this._y=e,this._x0=n,this._y0=i,this._x1=a,this._y1=s,this._root=void 0}function Bn(t){for(var e={data:t.data},n=e;t=t.next;)n=n.next={data:t.data};return e}var it=rn.prototype=on.prototype;it.copy=function(){var t=new on(this._x,this._y,this._x0,this._y0,this._x1,this._y1),e=this._root,n,i;if(!e)return t;if(!e.length)return t._root=Bn(e),t;for(n=[{source:e,target:t._root=new Array(4)}];e=n.pop();)for(var a=0;a<4;++a)(i=e.source[a])&&(i.length?n.push({source:i,target:e.target[a]=new Array(4)}):e.target[a]=Bn(i));return t};it.add=Yo;it.addAll=Vo;it.cover=qo;it.data=Uo;it.extent=Xo;it.find=Wo;it.remove=Jo;it.removeAll=Ko;it.root=Qo;it.size=Zo;it.visit=tl;it.visitAfter=el;it.x=il;it.y=sl;function nt(t){return function(){return t}}function _t(t){return(t()-.5)*1e-6}function rl(t){return t.x+t.vx}function ol(t){return t.y+t.vy}function ll(t){var e,n,i,a=1,s=1;typeof t!="function"&&(t=nt(t==null?1:+t));function r(){for(var l,d=e.length,_,f,h,E,y,x,g=0;g<s;++g)for(_=rn(e,rl,ol).visitAfter(o),l=0;l<d;++l)f=e[l],y=n[f.index],x=y*y,h=f.x+f.vx,E=f.y+f.vy,_.visit(k);function k(N,v,C,b,I){var M=N.data,B=N.r,T=y+B;if(M){if(M.index>f.index){var R=h-M.x-M.vx,j=E-M.y-M.vy,Y=R*R+j*j;Y<T*T&&(R===0&&(R=_t(i),Y+=R*R),j===0&&(j=_t(i),Y+=j*j),Y=(T-(Y=Math.sqrt(Y)))/Y*a,f.vx+=(R*=Y)*(T=(B*=B)/(x+B)),f.vy+=(j*=Y)*T,M.vx-=R*(T=1-T),M.vy-=j*T)}return}return v>h+T||b<h-T||C>E+T||I<E-T}}function o(l){if(l.data)return l.r=n[l.data.index];for(var d=l.r=0;d<4;++d)l[d]&&l[d].r>l.r&&(l.r=l[d].r)}function c(){if(e){var l,d=e.length,_;for(n=new Array(d),l=0;l<d;++l)_=e[l],n[_.index]=+t(_,l,e)}}return r.initialize=function(l,d){e=l,i=d,c()},r.iterations=function(l){return arguments.length?(s=+l,r):s},r.strength=function(l){return arguments.length?(a=+l,r):a},r.radius=function(l){return arguments.length?(t=typeof l=="function"?l:nt(+l),c(),r):t},r}function cl(t){return t.index}function Pn(t,e){var n=t.get(e);if(!n)throw new Error("node not found: "+e);return n}function dl(t){var e=cl,n=_,i,a=nt(30),s,r,o,c,l,d=1;t==null&&(t=[]);function _(x){return 1/Math.min(o[x.source.index],o[x.target.index])}function f(x){for(var g=0,k=t.length;g<d;++g)for(var N=0,v,C,b,I,M,B,T;N<k;++N)v=t[N],C=v.source,b=v.target,I=b.x+b.vx-C.x-C.vx||_t(l),M=b.y+b.vy-C.y-C.vy||_t(l),B=Math.sqrt(I*I+M*M),B=(B-s[N])/B*x*i[N],I*=B,M*=B,b.vx-=I*(T=c[N]),b.vy-=M*T,C.vx+=I*(T=1-T),C.vy+=M*T}function h(){if(r){var x,g=r.length,k=t.length,N=new Map(r.map((C,b)=>[e(C,b,r),C])),v;for(x=0,o=new Array(g);x<k;++x)v=t[x],v.index=x,typeof v.source!="object"&&(v.source=Pn(N,v.source)),typeof v.target!="object"&&(v.target=Pn(N,v.target)),o[v.source.index]=(o[v.source.index]||0)+1,o[v.target.index]=(o[v.target.index]||0)+1;for(x=0,c=new Array(k);x<k;++x)v=t[x],c[x]=o[v.source.index]/(o[v.source.index]+o[v.target.index]);i=new Array(k),E(),s=new Array(k),y()}}function E(){if(r)for(var x=0,g=t.length;x<g;++x)i[x]=+n(t[x],x,t)}function y(){if(r)for(var x=0,g=t.length;x<g;++x)s[x]=+a(t[x],x,t)}return f.initialize=function(x,g){r=x,l=g,h()},f.links=function(x){return arguments.length?(t=x,h(),f):t},f.id=function(x){return arguments.length?(e=x,f):e},f.iterations=function(x){return arguments.length?(d=+x,f):d},f.strength=function(x){return arguments.length?(n=typeof x=="function"?x:nt(+x),E(),f):n},f.distance=function(x){return arguments.length?(a=typeof x=="function"?x:nt(+x),y(),f):a},f}const ul=1664525,pl=1013904223,Rn=4294967296;function fl(){let t=1;return()=>(t=(ul*t+pl)%Rn)/Rn}function hl(t){return t.x}function ml(t){return t.y}var gl=10,vl=Math.PI*(3-Math.sqrt(5));function yl(t){var e,n=1,i=.001,a=1-Math.pow(i,1/300),s=0,r=.6,o=new Map,c=nn(_),l=Yt("tick","end"),d=fl();t==null&&(t=[]);function _(){f(),l.call("tick",e),n<i&&(c.stop(),l.call("end",e))}function f(y){var x,g=t.length,k;y===void 0&&(y=1);for(var N=0;N<y;++N)for(n+=(s-n)*a,o.forEach(function(v){v(n)}),x=0;x<g;++x)k=t[x],k.fx==null?k.x+=k.vx*=r:(k.x=k.fx,k.vx=0),k.fy==null?k.y+=k.vy*=r:(k.y=k.fy,k.vy=0);return e}function h(){for(var y=0,x=t.length,g;y<x;++y){if(g=t[y],g.index=y,g.fx!=null&&(g.x=g.fx),g.fy!=null&&(g.y=g.fy),isNaN(g.x)||isNaN(g.y)){var k=gl*Math.sqrt(.5+y),N=y*vl;g.x=k*Math.cos(N),g.y=k*Math.sin(N)}(isNaN(g.vx)||isNaN(g.vy))&&(g.vx=g.vy=0)}}function E(y){return y.initialize&&y.initialize(t,d),y}return h(),e={tick:f,restart:function(){return c.restart(_),e},stop:function(){return c.stop(),e},nodes:function(y){return arguments.length?(t=y,h(),o.forEach(E),e):t},alpha:function(y){return arguments.length?(n=+y,e):n},alphaMin:function(y){return arguments.length?(i=+y,e):i},alphaDecay:function(y){return arguments.length?(a=+y,e):+a},alphaTarget:function(y){return arguments.length?(s=+y,e):s},velocityDecay:function(y){return arguments.length?(r=1-y,e):1-r},randomSource:function(y){return arguments.length?(d=y,o.forEach(E),e):d},force:function(y,x){return arguments.length>1?(x==null?o.delete(y):o.set(y,E(x)),e):o.get(y)},find:function(y,x,g){var k=0,N=t.length,v,C,b,I,M;for(g==null?g=1/0:g*=g,k=0;k<N;++k)I=t[k],v=y-I.x,C=x-I.y,b=v*v+C*C,b<g&&(M=I,g=b);return M},on:function(y,x){return arguments.length>1?(l.on(y,x),e):l.on(y)}}}function bl(){var t,e,n,i,a=nt(-30),s,r=1,o=1/0,c=.81;function l(h){var E,y=t.length,x=rn(t,hl,ml).visitAfter(_);for(i=h,E=0;E<y;++E)e=t[E],x.visit(f)}function d(){if(t){var h,E=t.length,y;for(s=new Array(E),h=0;h<E;++h)y=t[h],s[y.index]=+a(y,h,t)}}function _(h){var E=0,y,x,g=0,k,N,v;if(h.length){for(k=N=v=0;v<4;++v)(y=h[v])&&(x=Math.abs(y.value))&&(E+=y.value,g+=x,k+=x*y.x,N+=x*y.y);h.x=k/g,h.y=N/g}else{y=h,y.x=y.data.x,y.y=y.data.y;do E+=s[y.data.index];while(y=y.next)}h.value=E}function f(h,E,y,x){if(!h.value)return!0;var g=h.x-e.x,k=h.y-e.y,N=x-E,v=g*g+k*k;if(N*N/c<v)return v<o&&(g===0&&(g=_t(n),v+=g*g),k===0&&(k=_t(n),v+=k*k),v<r&&(v=Math.sqrt(r*v)),e.vx+=g*h.value*i/v,e.vy+=k*h.value*i/v),!0;if(h.length||v>=o)return;(h.data!==e||h.next)&&(g===0&&(g=_t(n),v+=g*g),k===0&&(k=_t(n),v+=k*k),v<r&&(v=Math.sqrt(r*v)));do h.data!==e&&(N=s[h.data.index]*i/v,e.vx+=g*N,e.vy+=k*N);while(h=h.next)}return l.initialize=function(h,E){t=h,n=E,d()},l.strength=function(h){return arguments.length?(a=typeof h=="function"?h:nt(+h),d(),l):a},l.distanceMin=function(h){return arguments.length?(r=h*h,l):Math.sqrt(r)},l.distanceMax=function(h){return arguments.length?(o=h*h,l):Math.sqrt(o)},l.theta=function(h){return arguments.length?(c=h*h,l):Math.sqrt(c)},l}function _l(t){var e=nt(.1),n,i,a;typeof t!="function"&&(t=nt(t==null?0:+t));function s(o){for(var c=0,l=n.length,d;c<l;++c)d=n[c],d.vx+=(a[c]-d.x)*i[c]*o}function r(){if(n){var o,c=n.length;for(i=new Array(c),a=new Array(c),o=0;o<c;++o)i[o]=isNaN(a[o]=+t(n[o],o,n))?0:+e(n[o],o,n)}}return s.initialize=function(o){n=o,r()},s.strength=function(o){return arguments.length?(e=typeof o=="function"?o:nt(+o),r(),s):e},s.x=function(o){return arguments.length?(t=typeof o=="function"?o:nt(+o),r(),s):t},s}function xl(t){var e=nt(.1),n,i,a;typeof t!="function"&&(t=nt(t==null?0:+t));function s(o){for(var c=0,l=n.length,d;c<l;++c)d=n[c],d.vy+=(a[c]-d.y)*i[c]*o}function r(){if(n){var o,c=n.length;for(i=new Array(c),a=new Array(c),o=0;o<c;++o)i[o]=isNaN(a[o]=+t(n[o],o,n))?0:+e(n[o],o,n)}}return s.initialize=function(o){n=o,r()},s.strength=function(o){return arguments.length?(e=typeof o=="function"?o:nt(+o),r(),s):e},s.y=function(o){return arguments.length?(t=typeof o=="function"?o:nt(+o),r(),s):t},s}const Zt=t=>()=>t;function wl(t,{sourceEvent:e,target:n,transform:i,dispatch:a}){Object.defineProperties(this,{type:{value:t,enumerable:!0,configurable:!0},sourceEvent:{value:e,enumerable:!0,configurable:!0},target:{value:n,enumerable:!0,configurable:!0},transform:{value:i,enumerable:!0,configurable:!0},_:{value:a}})}function gt(t,e,n){this.k=t,this.x=e,this.y=n}gt.prototype={constructor:gt,scale:function(t){return t===1?this:new gt(this.k*t,this.x,this.y)},translate:function(t,e){return t===0&e===0?this:new gt(this.k,this.x+this.k*t,this.y+this.k*e)},apply:function(t){return[t[0]*this.k+this.x,t[1]*this.k+this.y]},applyX:function(t){return t*this.k+this.x},applyY:function(t){return t*this.k+this.y},invert:function(t){return[(t[0]-this.x)/this.k,(t[1]-this.y)/this.k]},invertX:function(t){return(t-this.x)/this.k},invertY:function(t){return(t-this.y)/this.k},rescaleX:function(t){return t.copy().domain(t.range().map(this.invertX,this).map(t.invert,t))},rescaleY:function(t){return t.copy().domain(t.range().map(this.invertY,this).map(t.invert,t))},toString:function(){return"translate("+this.x+","+this.y+") scale("+this.k+")"}};var Si=new gt(1,0,0);gt.prototype;function Te(t){t.stopImmediatePropagation()}function Pt(t){t.preventDefault(),t.stopImmediatePropagation()}function El(t){return(!t.ctrlKey||t.type==="wheel")&&!t.button}function $l(){var t=this;return t instanceof SVGElement?(t=t.ownerSVGElement||t,t.hasAttribute("viewBox")?(t=t.viewBox.baseVal,[[t.x,t.y],[t.x+t.width,t.y+t.height]]):[[0,0],[t.width.baseVal.value,t.height.baseVal.value]]):[[0,0],[t.clientWidth,t.clientHeight]]}function On(){return this.__zoom||Si}function kl(t){return-t.deltaY*(t.deltaMode===1?.05:t.deltaMode?1:.002)*(t.ctrlKey?10:1)}function Il(){return navigator.maxTouchPoints||"ontouchstart"in this}function Tl(t,e,n){var i=t.invertX(e[0][0])-n[0][0],a=t.invertX(e[1][0])-n[1][0],s=t.invertY(e[0][1])-n[0][1],r=t.invertY(e[1][1])-n[1][1];return t.translate(a>i?(i+a)/2:Math.min(0,i)||Math.max(0,a),r>s?(s+r)/2:Math.min(0,s)||Math.max(0,r))}function Sl(){var t=El,e=$l,n=Tl,i=kl,a=Il,s=[0,1/0],r=[[-1/0,-1/0],[1/0,1/0]],o=250,c=Nr,l=Yt("start","zoom","end"),d,_,f,h=500,E=150,y=0,x=10;function g(m){m.property("__zoom",On).on("wheel.zoom",M,{passive:!1}).on("mousedown.zoom",B).on("dblclick.zoom",T).filter(a).on("touchstart.zoom",R).on("touchmove.zoom",j).on("touchend.zoom touchcancel.zoom",Y).style("-webkit-tap-highlight-color","rgba(0,0,0,0)")}g.transform=function(m,u,p,w){var A=m.selection?m.selection():m;A.property("__zoom",On),m!==A?C(m,u,p,w):A.interrupt().each(function(){b(this,arguments).event(w).start().zoom(null,typeof u=="function"?u.apply(this,arguments):u).end()})},g.scaleBy=function(m,u,p,w){g.scaleTo(m,function(){var A=this.__zoom.k,L=typeof u=="function"?u.apply(this,arguments):u;return A*L},p,w)},g.scaleTo=function(m,u,p,w){g.transform(m,function(){var A=e.apply(this,arguments),L=this.__zoom,P=p==null?v(A):typeof p=="function"?p.apply(this,arguments):p,z=L.invert(P),H=typeof u=="function"?u.apply(this,arguments):u;return n(N(k(L,H),P,z),A,r)},p,w)},g.translateBy=function(m,u,p,w){g.transform(m,function(){return n(this.__zoom.translate(typeof u=="function"?u.apply(this,arguments):u,typeof p=="function"?p.apply(this,arguments):p),e.apply(this,arguments),r)},null,w)},g.translateTo=function(m,u,p,w,A){g.transform(m,function(){var L=e.apply(this,arguments),P=this.__zoom,z=w==null?v(L):typeof w=="function"?w.apply(this,arguments):w;return n(Si.translate(z[0],z[1]).scale(P.k).translate(typeof u=="function"?-u.apply(this,arguments):-u,typeof p=="function"?-p.apply(this,arguments):-p),L,r)},w,A)};function k(m,u){return u=Math.max(s[0],Math.min(s[1],u)),u===m.k?m:new gt(u,m.x,m.y)}function N(m,u,p){var w=u[0]-p[0]*m.k,A=u[1]-p[1]*m.k;return w===m.x&&A===m.y?m:new gt(m.k,w,A)}function v(m){return[(+m[0][0]+ +m[1][0])/2,(+m[0][1]+ +m[1][1])/2]}function C(m,u,p,w){m.on("start.zoom",function(){b(this,arguments).event(w).start()}).on("interrupt.zoom end.zoom",function(){b(this,arguments).event(w).end()}).tween("zoom",function(){var A=this,L=arguments,P=b(A,L).event(w),z=e.apply(A,L),H=p==null?v(z):typeof p=="function"?p.apply(A,L):p,U=Math.max(z[1][0]-z[0][0],z[1][1]-z[0][1]),G=A.__zoom,q=typeof u=="function"?u.apply(A,L):u,W=c(G.invert(H).concat(U/G.k),q.invert(H).concat(U/q.k));return function(V){if(V===1)V=q;else{var J=W(V),xt=U/J[2];V=new gt(xt,H[0]-J[0]*xt,H[1]-J[1]*xt)}P.zoom(null,V)}})}function b(m,u,p){return!p&&m.__zooming||new I(m,u)}function I(m,u){this.that=m,this.args=u,this.active=0,this.sourceEvent=null,this.extent=e.apply(m,u),this.taps=0}I.prototype={event:function(m){return m&&(this.sourceEvent=m),this},start:function(){return++this.active===1&&(this.that.__zooming=this,this.emit("start")),this},zoom:function(m,u){return this.mouse&&m!=="mouse"&&(this.mouse[1]=u.invert(this.mouse[0])),this.touch0&&m!=="touch"&&(this.touch0[1]=u.invert(this.touch0[0])),this.touch1&&m!=="touch"&&(this.touch1[1]=u.invert(this.touch1[0])),this.that.__zoom=u,this.emit("zoom"),this},end:function(){return--this.active===0&&(delete this.that.__zooming,this.emit("end")),this},emit:function(m){var u=Z(this.that).datum();l.call(m,this.that,new wl(m,{sourceEvent:this.sourceEvent,target:g,transform:this.that.__zoom,dispatch:l}),u)}};function M(m,...u){if(!t.apply(this,arguments))return;var p=b(this,u).event(m),w=this.__zoom,A=Math.max(s[0],Math.min(s[1],w.k*Math.pow(2,i.apply(this,arguments)))),L=mt(m);if(p.wheel)(p.mouse[0][0]!==L[0]||p.mouse[0][1]!==L[1])&&(p.mouse[1]=w.invert(p.mouse[0]=L)),clearTimeout(p.wheel);else{if(w.k===A)return;p.mouse=[L,w.invert(L)],ce(this),p.start()}Pt(m),p.wheel=setTimeout(P,E),p.zoom("mouse",n(N(k(w,A),p.mouse[0],p.mouse[1]),p.extent,r));function P(){p.wheel=null,p.end()}}function B(m,...u){if(f||!t.apply(this,arguments))return;var p=m.currentTarget,w=b(this,u,!0).event(m),A=Z(m.view).on("mousemove.zoom",H,!0).on("mouseup.zoom",U,!0),L=mt(m,p),P=m.clientX,z=m.clientY;fi(m.view),Te(m),w.mouse=[L,this.__zoom.invert(L)],ce(this),w.start();function H(G){if(Pt(G),!w.moved){var q=G.clientX-P,W=G.clientY-z;w.moved=q*q+W*W>y}w.event(G).zoom("mouse",n(N(w.that.__zoom,w.mouse[0]=mt(G,p),w.mouse[1]),w.extent,r))}function U(G){A.on("mousemove.zoom mouseup.zoom",null),hi(G.view,w.moved),Pt(G),w.event(G).end()}}function T(m,...u){if(t.apply(this,arguments)){var p=this.__zoom,w=mt(m.changedTouches?m.changedTouches[0]:m,this),A=p.invert(w),L=p.k*(m.shiftKey?.5:2),P=n(N(k(p,L),w,A),e.apply(this,u),r);Pt(m),o>0?Z(this).transition().duration(o).call(C,P,w,m):Z(this).call(g.transform,P,w,m)}}function R(m,...u){if(t.apply(this,arguments)){var p=m.touches,w=p.length,A=b(this,u,m.changedTouches.length===w).event(m),L,P,z,H;for(Te(m),P=0;P<w;++P)z=p[P],H=mt(z,this),H=[H,this.__zoom.invert(H),z.identifier],A.touch0?!A.touch1&&A.touch0[2]!==H[2]&&(A.touch1=H,A.taps=0):(A.touch0=H,L=!0,A.taps=1+!!d);d&&(d=clearTimeout(d)),L&&(A.taps<2&&(_=H[0],d=setTimeout(function(){d=null},h)),ce(this),A.start())}}function j(m,...u){if(this.__zooming){var p=b(this,u).event(m),w=m.changedTouches,A=w.length,L,P,z,H;for(Pt(m),L=0;L<A;++L)P=w[L],z=mt(P,this),p.touch0&&p.touch0[2]===P.identifier?p.touch0[0]=z:p.touch1&&p.touch1[2]===P.identifier&&(p.touch1[0]=z);if(P=p.that.__zoom,p.touch1){var U=p.touch0[0],G=p.touch0[1],q=p.touch1[0],W=p.touch1[1],V=(V=q[0]-U[0])*V+(V=q[1]-U[1])*V,J=(J=W[0]-G[0])*J+(J=W[1]-G[1])*J;P=k(P,Math.sqrt(V/J)),z=[(U[0]+q[0])/2,(U[1]+q[1])/2],H=[(G[0]+W[0])/2,(G[1]+W[1])/2]}else if(p.touch0)z=p.touch0[0],H=p.touch0[1];else return;p.zoom("touch",n(N(P,z,H),p.extent,r))}}function Y(m,...u){if(this.__zooming){var p=b(this,u).event(m),w=m.changedTouches,A=w.length,L,P;for(Te(m),f&&clearTimeout(f),f=setTimeout(function(){f=null},h),L=0;L<A;++L)P=w[L],p.touch0&&p.touch0[2]===P.identifier?delete p.touch0:p.touch1&&p.touch1[2]===P.identifier&&delete p.touch1;if(p.touch1&&!p.touch0&&(p.touch0=p.touch1,delete p.touch1),p.touch0)p.touch0[1]=this.__zoom.invert(p.touch0[0]);else if(p.end(),p.taps===2&&(P=mt(P,this),Math.hypot(_[0]-P[0],_[1]-P[1])<x)){var z=Z(this).on("dblclick.zoom");z&&z.apply(this,arguments)}}}return g.wheelDelta=function(m){return arguments.length?(i=typeof m=="function"?m:Zt(+m),g):i},g.filter=function(m){return arguments.length?(t=typeof m=="function"?m:Zt(!!m),g):t},g.touchable=function(m){return arguments.length?(a=typeof m=="function"?m:Zt(!!m),g):a},g.extent=function(m){return arguments.length?(e=typeof m=="function"?m:Zt([[+m[0][0],+m[0][1]],[+m[1][0],+m[1][1]]]),g):e},g.scaleExtent=function(m){return arguments.length?(s[0]=+m[0],s[1]=+m[1],g):[s[0],s[1]]},g.translateExtent=function(m){return arguments.length?(r[0][0]=+m[0][0],r[1][0]=+m[1][0],r[0][1]=+m[0][1],r[1][1]=+m[1][1],g):[[r[0][0],r[0][1]],[r[1][0],r[1][1]]]},g.constrain=function(m){return arguments.length?(n=m,g):n},g.duration=function(m){return arguments.length?(o=+m,g):o},g.interpolate=function(m){return arguments.length?(c=m,g):c},g.on=function(){var m=l.on.apply(l,arguments);return m===l?g:m},g.clickDistance=function(m){return arguments.length?(y=(m=+m)*m,g):Math.sqrt(y)},g.tapDistance=function(m){return arguments.length?(x=+m,g):x},g}let te=null,ct=null,St=!0,Fe=null,Ge=null,bt=new Set;const Dn=["#FF6B35","#004E89","#7B2D8E","#1A936F","#C5283D","#E9724C","#3498db","#9b59b6","#27ae60","#f39c12"];function Al(t){var n;const e=window.appState.projectId;ct=null,bt=new Set,t.innerHTML=`
  ...
  `,(n=document.getElementById("edge-label-checkbox"))==null||n.addEventListener("change",i=>{St=i.target.checked,Fe&&Fe.style("display",St?"block":"none"),Ge&&Ge.style("display",St?"block":"none")}),e&&Nl(e)}async function Nl(t){try{const[e,n]=await Promise.all([X.getGraph(t),X.getAgents(t)]),i=e.nodes||[],a=e.edges||[],s=n.agents||[];document.getElementById("graph-stats").textContent=`NODES: ${i.length} | EDGES: ${a.length} | AGENTS: ${s.length}`,Cl(s),Ll(i,a)}catch(e){document.getElementById("graph-stats").textContent=S("graph_load_error"),console.error("Graph load error:",e)}}function Cl(t){const e=document.getElementById("agents-list");if(!t.length){e.innerHTML=`<p class="muted mono-xs">${S("graph_no_agents")}</p>`;return}const n={Self:"person",Family:"family_restroom",Mentor:"school",Partner:"favorite",School:"domain",Employer:"business",City:"location_city",Industry:"trending_up",Risk:"warning"};e.innerHTML=t.map(i=>`
  ...
  `,(r=document.getElementById("gd-close"))==null||r.addEventListener("click",o=>{o.stopPropagation(),xe()})}function Bl(t,e){var i,a;const n=e.data;if(n.isSelfLoopGroup){Ai(t,n);return}t.innerHTML=`
    <div class="gd-panel-header">
